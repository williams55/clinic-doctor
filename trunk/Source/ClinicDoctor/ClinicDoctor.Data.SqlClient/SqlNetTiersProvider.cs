...
namespace ClinicDoctor.Data.SqlClient
{
	...
	public sealed class SqlNetTiersProvider : ClinicDoctor.Data.Bases.NetTiersProvider
	{
		...
		private SqlStaffRolesProvider innerSqlStaffRolesProvider;

		///<summary>
		/// This class is the Data Access Logic Component for the <see cref="StaffRoles"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		/// <value></value>
		public override StaffRolesProviderBase StaffRolesProvider
		{
			get
			{
				if (innerSqlStaffRolesProvider == null) 
				{
					lock (syncRoot) 
					{
						if (innerSqlStaffRolesProvider == null)
						{
							this.innerSqlStaffRolesProvider = new SqlStaffRolesProvider(_connectionString, _useStoredProcedure, _providerInvariantName);
						}
					}
				}
				return innerSqlStaffRolesProvider;
			}
		}
		
		/// <summary>
		/// Gets the current <c cref="SqlStaffRolesProvider"/>.
		/// </summary>
		/// <value></value>
		public SqlStaffRolesProvider SqlStaffRolesProvider
		{
			get {return StaffRolesProvider as SqlStaffRolesProvider;}
		}
		...
		private SqlNurseAppointmentProvider innerSqlNurseAppointmentProvider;

		///<summary>
		/// This class is the Data Access Logic Component for the <see cref="NurseAppointment"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		/// <value></value>
		public override NurseAppointmentProviderBase NurseAppointmentProvider
		{
			get
			{
				if (innerSqlNurseAppointmentProvider == null) 
				{
					lock (syncRoot) 
					{
						if (innerSqlNurseAppointmentProvider == null)
						{
							this.innerSqlNurseAppointmentProvider = new SqlNurseAppointmentProvider(_connectionString, _useStoredProcedure, _providerInvariantName);
						}
					}
				}
				return innerSqlNurseAppointmentProvider;
			}
		}
		
		/// <summary>
		/// Gets the current <c cref="SqlNurseAppointmentProvider"/>.
		/// </summary>
		/// <value></value>
		public SqlNurseAppointmentProvider SqlNurseAppointmentProvider
		{
			get {return NurseAppointmentProvider as SqlNurseAppointmentProvider;}
		}
		...
		private SqlGroupRolesProvider innerSqlGroupRolesProvider;

		///<summary>
		/// This class is the Data Access Logic Component for the <see cref="GroupRoles"/> business entity.
		/// It exposes CRUD methods as well as selecting on index, foreign keys and custom stored procedures.
		///</summary>
		/// <value></value>
		public override GroupRolesProviderBase GroupRolesProvider
		{
			get
			{
				if (innerSqlGroupRolesProvider == null) 
				{
					lock (syncRoot) 
					{
						if (innerSqlGroupRolesProvider == null)
						{
							this.innerSqlGroupRolesProvider = new SqlGroupRolesProvider(_connectionString, _useStoredProcedure, _providerInvariantName);
						}
					}
				}
				return innerSqlGroupRolesProvider;
			}
		}
		
		/// <summary>
		/// Gets the current <c cref="SqlGroupRolesProvider"/>.
		/// </summary>
		/// <value></value>
		public SqlGroupRolesProvider SqlGroupRolesProvider
		{
			get {return GroupRolesProvider as SqlGroupRolesProvider;}
		}

...
namespace ClinicDoctor.Entities
{
	...
	{		
		...
		public DoctorRoomBase(System.Int32? _doctorId, System.Int32? _roomId, System.Int32? _priorityIndex, 
		...
		///<param name="_updateUser"></param>
		///<param name="_updateDate"></param>
		public static DoctorRoom CreateDoctorRoom(System.Int32? _doctorId, System.Int32? _roomId, System.Int32? _priorityIndex, 
			System.Boolean? _isDisabled, System.String _createUser, System.DateTime? _createDate, System.String _updateUser, 
			System.DateTime? _updateDate)
		{
		...
		/// This property can be set to null. 
		/// If this column is null, this property will return (int)0. It is up to the developer
		/// to check the value of IsPriorityIndexNull() and perform business logic appropriately.
		/// </remarks>
	...
	#region Value Semantics Instance Equality
        ...
        public override int GetHashCode()
        {
			return this.Id.GetHashCode() ^ 
					...
					((this.PriorityIndex == null) ? string.Empty : this.PriorityIndex.ToString()).GetHashCode() ^ 
		...
		public static bool ValueEquals(DoctorRoomBase Object1, DoctorRoomBase Object2)
		{
			...
			if ( Object1.PriorityIndex != null && Object2.PriorityIndex != null )
			{
				if (Object1.PriorityIndex != Object2.PriorityIndex)
					equal = false;
			}
			else if (Object1.PriorityIndex == null ^ Object2.PriorityIndex == null )
			{
				equal = false;
			}
...
/*
        ...
        public int CompareTo(DoctorRoom rhs, DoctorRoomColumn which)
        {
            switch (which)
            {
            	...
            	case DoctorRoomColumn.PriorityIndex:
            		return this.PriorityIndex.Value.CompareTo(rhs.PriorityIndex.Value);
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				...
				(this.PriorityIndex == null) ? string.Empty : this.PriorityIndex.ToString(),
	...
	internal protected class DoctorRoomEntityData : ICloneable, ICloneableEx
	{
		...
		/// PriorityIndex : 
		/// </summary>
		public System.Int32?		  PriorityIndex = null;
	...
	public class DoctorRoomKey : EntityKeyBase
	{
		...
		/// Initializes a new instance of the DoctorRoomKey class.
		/// </summary>
		public DoctorRoomKey(System.Int32 _id)
		{
			#region Init Properties
	...
	public enum DoctorRoomColumn : int
	{
		...
		[ColumnEnum("PriorityIndex", typeof(System.Int32), System.Data.DbType.Int32, false, false, true)]
		PriorityIndex = 4,
		/// <summary>
		/// IsDisabled : 
		/// </summary>

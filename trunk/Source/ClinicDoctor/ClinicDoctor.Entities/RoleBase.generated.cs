...
namespace ClinicDoctor.Entities
{
	...
	{		
		...
		public RoleBase(System.String _title, System.String _note, System.Boolean? _isDisabled, 
		...
		///<param name="_updateUser"></param>
		///<param name="_updateDate"></param>
		public static Role CreateRole(System.String _title, System.String _note, System.Boolean? _isDisabled, 
			System.String _createUser, System.DateTime? _createDate, System.String _updateUser, System.DateTime? _updateDate)
		{
		...
		///	which are related to this object through the relation FK_StaffRoles_Role
		/// </summary>	
		...
		/// <summary>
		///	Holds a collection of GroupRoles objects
		///	which are related to this object through the relation FK_GroupRoles_Role
		/// </summary>	
		[System.ComponentModel.Bindable(System.ComponentModel.BindableSupport.Yes)]
		public virtual TList<GroupRoles> GroupRolesCollection
		{
			get { return entityData.GroupRolesCollection; }
			set { entityData.GroupRolesCollection = value; }	
		}
		...
		protected virtual Role Copy(IDictionary existingCopies)
		{
			...
			copy.GroupRolesCollection = (TList<GroupRoles>) MakeCopyOf(this.GroupRolesCollection, existingCopies); 
...
/*
	...
	internal protected class RoleEntityData : ICloneable, ICloneableEx
	{
		...
		private TList<StaffRoles> _staffRolesRoleId;
		
		/// <summary>
		///	Holds a collection of entity objects
		///	which are related to this object through the relation _staffRolesRoleId
		/// </summary>
		...
		public TList<StaffRoles> StaffRolesCollection
		{
			get
			{
				if (_staffRolesRoleId == null)
				{
				_staffRolesRoleId = new TList<StaffRoles>();
				}
	
				return _staffRolesRoleId;
			}
			set { _staffRolesRoleId = value; }
		}
		...
		private TList<GroupRoles> _groupRolesRoleId;
		
		/// <summary>
		///	Holds a collection of entity objects
		///	which are related to this object through the relation _groupRolesRoleId
		/// </summary>
		
		public TList<GroupRoles> GroupRolesCollection
		{
			get
			{
				if (_groupRolesRoleId == null)
				{
				_groupRolesRoleId = new TList<GroupRoles>();
				}
	
				return _groupRolesRoleId;
			}
			set { _groupRolesRoleId = value; }
		}
		...
		public Object Clone()
		{
			...
			//deep copy nested objects
			if (this._staffRolesRoleId != null)
				_tmp.StaffRolesCollection = (TList<StaffRoles>) MakeCopyOf(this.StaffRolesCollection); 
			if (this._groupRolesRoleId != null)
				_tmp.GroupRolesCollection = (TList<GroupRoles>) MakeCopyOf(this.GroupRolesCollection); 
		...
		public object Clone(IDictionary existingCopies)
		{
			...
			_tmp.GroupRolesCollection = (TList<GroupRoles>) MakeCopyOf(this.GroupRolesCollection, existingCopies); 
			#endregion Child Collections

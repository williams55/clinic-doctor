...
namespace ClinicDoctor.Entities
{
	...
	{		
		...
		/// to check the value of IsIsBookedNull() and perform business logic appropriately.
		/// </remarks>
		...
		///	which are related to this object through the relation FK_Roster_RosterType
		/// </summary>	
	...
	#region Value Semantics Instance Equality
        ...
        public override int GetHashCode()
        {
			return this.Id.GetHashCode() ^ 
					...
					((this.IsBooked == null) ? string.Empty : this.IsBooked.ToString()).GetHashCode() ^ 
		...
		public static bool ValueEquals(RosterTypeBase Object1, RosterTypeBase Object2)
		{
			...
			if ( Object1.IsBooked != null && Object2.IsBooked != null )
			{
				if (Object1.IsBooked != Object2.IsBooked)
					equal = false;
			}
			else if (Object1.IsBooked == null ^ Object2.IsBooked == null )
			{
				equal = false;
			}
...
/*
        ...
        public int CompareTo(RosterType rhs, RosterTypeColumn which)
        {
            switch (which)
            {
            	...
            	case RosterTypeColumn.IsBooked:
            		return this.IsBooked.Value.CompareTo(rhs.IsBooked.Value);
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				...
				(this.IsBooked == null) ? string.Empty : this.IsBooked.ToString(),
	...
	internal protected class RosterTypeEntityData : ICloneable, ICloneableEx
	{
		...
		/// IsBooked : 
		/// </summary>
		public System.Boolean?		  IsBooked = null;
		...
		private TList<Roster> _rosterRosterTypeId;
		...
		public TList<Roster> RosterCollection
		{
			get
			{
				if (_rosterRosterTypeId == null)
				{
				_rosterRosterTypeId = new TList<Roster>();
				}
	
				return _rosterRosterTypeId;
			}
			set { _rosterRosterTypeId = value; }
		}
		...
		public Object Clone()
		{
			...
			//deep copy nested objects
			if (this._rosterRosterTypeId != null)
	...
	public class RosterTypeKey : EntityKeyBase
	{
		...
		/// Initializes a new instance of the RosterTypeKey class.
		/// </summary>
		public RosterTypeKey(System.Int32 _id)
		{
			#region Init Properties

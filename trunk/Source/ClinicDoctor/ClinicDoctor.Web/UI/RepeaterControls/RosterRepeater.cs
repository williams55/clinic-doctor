...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						ClinicDoctor.Entities.Roster entity = o as ClinicDoctor.Entities.Roster;
	...
	{
		private ClinicDoctor.Entities.Roster _entity;
        ...
        /// Initializes a new instance of the <see cref="T:RosterItem"/> class.
        /// </summary>
		public RosterItem(ClinicDoctor.Entities.Roster entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:ClinicDoctor.Entities.Roster"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public ClinicDoctor.Entities.Roster Entity
        {
            get { return _entity; }
        }
	}

...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
					<data:EntityDropDownList runat="server" ID="dataCustomerId" DataSourceID="CustomerIdCustomerDataSource" DataTextField="FirstName" DataValueField="Id" SelectedValue='<%# Bind("CustomerId") %>' AppendNullItem="true" Required="false" NullItemText="< Please Choose ...>" />
        ...
        <td>
					<data:EntityDropDownList runat="server" ID="dataContentId" DataSourceID="ContentIdContentDataSource" DataTextField="Title" DataValueField="Id" SelectedValue='<%# Bind("ContentId") %>' AppendNullItem="true" Required="false" NullItemText="< Please Choose ...>" />

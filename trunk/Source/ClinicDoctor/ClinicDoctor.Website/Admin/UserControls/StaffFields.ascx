...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
					<asp:TextBox runat="server" ID="dataFirstName" Text='<%# Bind("FirstName") %>' MaxLength="200"></asp:TextBox>
				</td>
			</tr>
			<tr>
        <td class="literal"><asp:Label ID="lbldataLastName" runat="server" Text="Last Name:" AssociatedControlID="dataLastName" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataLastName" Text='<%# Bind("LastName") %>' MaxLength="200"></asp:TextBox>
				</td>
			</tr>
			<tr>
        <td class="literal"><asp:Label ID="lbldataShortName" runat="server" Text="Short Name:" AssociatedControlID="dataShortName" /></td>
        <td>
					<asp:TextBox runat="server" ID="dataShortName" Text='<%# Bind("ShortName") %>' MaxLength="50"></asp:TextBox>
				</td>
			</tr>
			<tr>
        ...
        <td>
					<asp:TextBox runat="server" ID="dataUserName" Text='<%# Bind("UserName") %>' MaxLength="200"></asp:TextBox>
				</td>
			</tr>
			<tr>

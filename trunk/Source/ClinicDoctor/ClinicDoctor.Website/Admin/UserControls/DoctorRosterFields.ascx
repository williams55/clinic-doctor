...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
					<data:EntityDropDownList runat="server" ID="dataRosterId" DataSourceID="RosterIdRosterDataSource" DataTextField="Note" DataValueField="Id" SelectedValue='<%# Bind("RosterId") %>' AppendNullItem="true" Required="false" NullItemText="< Please Choose ...>" />

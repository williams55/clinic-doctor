<%@ Control Language="C#" ClassName="GroupRolesFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
					<data:EntityDropDownList runat="server" ID="dataGroupId" DataSourceID="GroupIdGroupDataSource" DataTextField="Title" DataValueField="Id" SelectedValue='<%# Bind("GroupId") %>' AppendNullItem="true" Required="false" NullItemText="< Please Choose ...>" />

<%@ Control Language="C#" ClassName="StaffRolesFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
					<data:EntityDropDownList runat="server" ID="dataStaffId" DataSourceID="StaffIdStaffDataSource" DataTextField="FirstName" DataValueField="Id" SelectedValue='<%# Bind("StaffId") %>' AppendNullItem="true" Required="false" NullItemText="< Please Choose ...>" />
					<data:StaffDataSource ID="StaffIdStaffDataSource" runat="server" SelectMethod="GetAll"  />
				</td>
			</tr>
			<tr>

...
namespace AppointmentSystem.Web.UI
{
    ...
    /// <summary>
    /// A strongly typed repeater control for the <c cref="UsersRepeater"></c> Type.
    /// </summary>
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						AppointmentSystem.Entities.Users entity = o as AppointmentSystem.Entities.Users;
	...
	{
		private AppointmentSystem.Entities.Users _entity;
        ...
        /// Initializes a new instance of the <see cref="T:UsersItem"/> class.
        /// </summary>
		public UsersItem(AppointmentSystem.Entities.Users entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:AppointmentSystem.Entities.Users"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public AppointmentSystem.Entities.Users Entity
        {
            get { return _entity; }
        }
	}

<%@ Control Language="C#" ClassName="DoctorServiceFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
					<data:EntityDropDownList runat="server" ID="dataDoctorId" DataSourceID="DoctorIdUsersDataSource" DataTextField="Username" DataValueField="Id" SelectedValue='<%# Bind("DoctorId") %>' AppendNullItem="true" Required="true" NullItemText="< Please Choose ...>" ErrorText="Required" />
					<data:UsersDataSource ID="DoctorIdUsersDataSource" runat="server" SelectMethod="GetAll"  />
				</td>
			</tr>
			<tr>
        <td class="literal"><asp:Label ID="lbldataServiceId" runat="server" Text="Service Id:" AssociatedControlID="dataServiceId" /></td>
        <td>
					<data:EntityDropDownList runat="server" ID="dataServiceId" DataSourceID="ServiceIdServicesDataSource" DataTextField="Title" DataValueField="Id" SelectedValue='<%# Bind("ServiceId") %>' AppendNullItem="true" Required="true" NullItemText="< Please Choose ...>" ErrorText="Required" />
					<data:ServicesDataSource ID="ServiceIdServicesDataSource" runat="server" SelectMethod="GetAll"  />
				</td>
			</tr>
			<tr>

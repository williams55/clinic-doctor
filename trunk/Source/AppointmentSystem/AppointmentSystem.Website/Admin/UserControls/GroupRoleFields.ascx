<%@ Control Language="C#" ClassName="GroupRoleFields" %>
...
<asp:FormView ID="FormView1" runat="server">
	<ItemTemplate>
        ...
        <td>
					<data:EntityDropDownList runat="server" ID="dataGroupId" DataSourceID="GroupIdUserGroupDataSource" DataTextField="Title" DataValueField="Id" SelectedValue='<%# Bind("GroupId") %>' AppendNullItem="true" Required="true" NullItemText="< Please Choose ...>" ErrorText="Required" />
					<data:UserGroupDataSource ID="GroupIdUserGroupDataSource" runat="server" SelectMethod="GetAll"  />
				</td>
			</tr>
			<tr>

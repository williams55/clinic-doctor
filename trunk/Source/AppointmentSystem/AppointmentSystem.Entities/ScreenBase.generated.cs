...
/*
	...
	Important: Do not modify this file. Edit the file Screen.cs instead.
*/
...
{
	///<summary>
	/// Define screen for role detail	
	///</summary>
	[Serializable]
	[DataObject, CLSCompliant(true)]
	public abstract partial class ScreenBase : EntityBase, IScreen, IEntityId<ScreenKey>, System.IComparable, System.ICloneable, ICloneableEx, IEditableObject, IComponent, INotifyPropertyChanged
	{		
		...
		/// </summary>
		private ScreenEntityData entityData;
		
		/// <summary>
		/// 	Hold the original data of the entity, as loaded from the repository.
		/// </summary>
		private ScreenEntityData _originalData;
		
		/// <summary>
		/// 	Hold a backup of the inner data of the entity.
		/// </summary>
		private ScreenEntityData backupData; 
		...
		[NonSerialized]
		private TList<Screen> parentCollection;
		...
		/// </summary>
		[field:NonSerialized]
		public event ScreenEventHandler ColumnChanging;		
		
		/// <summary>
		/// Occurs after a value has been changed for the specified column.
		/// </summary>
		[field:NonSerialized]
		public event ScreenEventHandler ColumnChanged;
		
		#endregion Variable Declarations
		
		#region Constructors
		///<summary>
		/// Creates a new <see cref="ScreenBase"/> instance.
		///</summary>
		public ScreenBase()
		{
		...
		///<summary>
		/// A simple factory method to create a new <see cref="Screen"/> instance.
		///</summary>
		///<param name="_screenCode">Link name of screen. 
		/// 		/// Ex: Status, Appointment...</param>
		///<param name="_screenName"></param>
			...
			System.DateTime _updateDate)
		{
			...
			newScreen.UpdateUser = _updateUser;
			newScreen.UpdateDate = _updateDate;
			return newScreen;
		}
		...
		/// <summary>
		/// 	Gets or sets the ScreenName property. 
		///		
		/// </summary>
		...
		public virtual System.String ScreenName
		{
			get
			{
				return this.entityData.ScreenName; 
			}
			
			set
			{
				if (this.entityData.ScreenName == value)
					return;
				
                OnPropertyChanging("ScreenName");                    
				OnColumnChanging(ScreenColumn.ScreenName, this.entityData.ScreenName);
				this.entityData.ScreenName = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
		...
		public virtual System.Boolean IsDisabled
		{
			...
			set
			{
				...
				OnColumnChanging(ScreenColumn.IsDisabled, this.entityData.IsDisabled);
				this.entityData.IsDisabled = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ScreenColumn.IsDisabled, this.entityData.IsDisabled);
		...
		public override System.String CreateUser
		{
			...
			set
			{
				...
				OnColumnChanging(ScreenColumn.CreateUser, this.entityData.CreateUser);
				this.entityData.CreateUser = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ScreenColumn.CreateUser, this.entityData.CreateUser);
		...
		public override System.DateTime CreateDate
		{
			...
			set
			{
				...
				OnColumnChanging(ScreenColumn.CreateDate, this.entityData.CreateDate);
				this.entityData.CreateDate = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ScreenColumn.CreateDate, this.entityData.CreateDate);
		...
		public override System.String UpdateUser
		{
			...
			set
			{
				...
				OnColumnChanging(ScreenColumn.UpdateUser, this.entityData.UpdateUser);
				this.entityData.UpdateUser = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ScreenColumn.UpdateUser, this.entityData.UpdateUser);
		...
		public override System.DateTime UpdateDate
		{
			...
			set
			{
				...
				OnColumnChanging(ScreenColumn.UpdateDate, this.entityData.UpdateDate);
				this.entityData.UpdateDate = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ScreenColumn.UpdateDate, this.entityData.UpdateDate);
		...
		///	which are related to this object through the relation FK_RoleDetail_Screen
		/// </summary>	
		...
		protected override void AddValidationRules()
		{
			...
			ValidationRules.AddRule( CommonRules.NotNull,
				new ValidationRuleArgs("ScreenCode", "Screen Code"));
			ValidationRules.AddRule( CommonRules.StringMaxLength, 
				new CommonRules.MaxLengthRuleArgs("ScreenCode", "Screen Code", 20));
			ValidationRules.AddRule( CommonRules.StringMaxLength, 
				new CommonRules.MaxLengthRuleArgs("ScreenName", "Screen Name", 50));
			ValidationRules.AddRule( CommonRules.StringMaxLength, 
		...
		void IEditableObject.BeginEdit() 
	    {
	        ...
	        if (!inTxn) 
	        {
	            this.backupData = this.entityData.Clone() as ScreenEntityData;
	            inTxn = true;
	        ...
	        if (this.inTxn) 
	        {
	        	...
	        	//if (this.EntityState == EntityState.Added)
	        	{
					if (this.parentCollection != null)
						this.parentCollection.Remove( (Screen) this ) ;
				}	            
	        }
	    ...
	    public override object ParentCollection
	    {
	        ...
	        set 
	        {
	            this.parentCollection = value as TList<Screen>;
	        }
	    }
	    ...
	    private void OnEntityChanged() 
	    {
	        ...
	        {
	            this.parentCollection.EntityChanged(this as Screen);
	        }
	    }
		...
		///<summary>
		///  Returns a Typed Screen Entity 
		///</summary>
		protected virtual Screen Copy(IDictionary existingCopies)
		{
		...
		///<summary>
		///  Returns a Typed Screen Entity which is a deep copy of the current entity.
		///</summary>
		public virtual Screen DeepCopy()
		{
			return EntityHelper.Clone<Screen>(this as Screen);	
		}
		#endregion
		...
		public override void CancelChanges()
		{
			...
			{
				this.entityData = this._originalData.Clone() as ScreenEntityData;
			}
			else
			{
		...
		public override void AcceptChanges()
		{
			...
			this._originalData = this.entityData.Clone() as ScreenEntityData;
		}
		...
		/// </returns>
		public bool IsPropertyChanged(ScreenColumn column)
		{
			switch(column)
			{
		...
		{
			return 	IsPropertyChanged(EntityHelper.GetEnumValue< ScreenColumn >(columnName));
		}
		...
		///<summary>
		///  Returns a Screen Entity with the original data.
		///</summary>
		public Screen GetOriginalEntity()
		{
	...
	#region Value Semantics Instance Equality
        ...
        ///<returns>true if Object1 is a <see cref="ScreenBase"/> and has the same value as this instance; otherwise, false.</returns>
        public override bool Equals(object Object1)
        {
			// Cast exception if Object1 is null or DbNull
			if (Object1 != null && Object1 != DBNull.Value && Object1 is ScreenBase)
				return ValueEquals(this, (ScreenBase)Object1);
			else
				return false;
        }
        ...
        /// Provides a hash function that is appropriate for <see cref="ScreenBase"/> class 
		...
		///<returns>true if toObject is a <see cref="ScreenBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(ScreenBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="ScreenBase"/> instances are considered equal using value semantics.
		///</summary>
		///<param name="Object1">The first <see cref="ScreenBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="ScreenBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool ValueEquals(ScreenBase Object1, ScreenBase Object2)
		{
			// both are null
			...
			{
				if (Object1.ScreenName != Object2.ScreenName)
					equal = false;
			}
			else if (Object1.ScreenName == null ^ Object2.ScreenName == null )
			{
				equal = false;
			}
		...
		public virtual int CompareTo(object obj)
		{
			...
			//return this. GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]) .CompareTo(((ScreenBase)obj).GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]));
		}
		
		/*
		// static method to get a Comparer object
        public static ScreenComparer GetComparer()
        {
            return new ScreenComparer();
        }
        */

        // Comparer delegates back to Screen
...
/*
        ...
        public int CompareTo(Screen rhs, ScreenColumn which)
        {
            switch (which)
            {
        ...
        */
		...
		#region IEntityKey<ScreenKey> Members
		
		// member variable for the EntityId property
		private ScreenKey _entityId;

		/// <summary>
		/// Gets or sets the EntityId property.
		/// </summary>
		[XmlIgnore]
		public virtual ScreenKey EntityId
		{
			get
			{
				if ( _entityId == null )
				{
					_entityId = new ScreenKey(this);
				}
	...
	/// <summary>
	///		The data structure representation of the 'Screen' table.
	/// </summary>
	/// <remarks>
	...
	[Serializable]
	internal protected class ScreenEntityData : ICloneable, ICloneableEx
	{
		#region Variable Declarations
		...
		/// </summary>
		/// <param name="column">The <see cref="ScreenColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanging(ScreenColumn column)
		{
		...
		/// </summary>
		/// <param name="column">The <see cref="ScreenColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanged(ScreenColumn column)
		{
		...
		public virtual void OnColumnChanging(ScreenColumn column, object value)
		{
			...
			if (!SuppressEntityEvents)
			{
				ScreenEventHandler handler = ColumnChanging;
				if(handler != null)
				{
					handler(this, new ScreenEventArgs(column, value));
				}
			}
		}
		...
		/// <param name="column">The <see cref="ScreenColumn"/> which has raised the event.</param>
		/// <param name="value">The changed value.</param>
		public virtual void OnColumnChanged(ScreenColumn column, object value)
		{
			if (!SuppressEntityEvents)
			{
				ScreenEventHandler handler = ColumnChanged;
				if(handler != null)
				{
					handler(this, new ScreenEventArgs(column, value));
				}
	...
	#region ScreenEventArgs class
	/// <summary>
	/// Provides data for the ColumnChanging and ColumnChanged events.
	/// </summary>
	/// <remarks>
	/// The ColumnChanging and ColumnChanged events occur when a change is made to the value 
	/// of a property of a <see cref="Screen"/> object.
	/// </remarks>
	public class ScreenEventArgs : System.EventArgs
	{
		private ScreenColumn column;
		private object value;
		
		///<summary>
		/// Initalizes a new Instance of the ScreenEventArgs class.
		///</summary>
		public ScreenEventArgs(ScreenColumn column)
		{
			this.column = column;
		}
		...
		/// Initalizes a new Instance of the ScreenEventArgs class.
		///</summary>
		public ScreenEventArgs(ScreenColumn column, object value)
		{
			this.column = column;
			this.value = value;
		}
		...
		///<summary>
		/// The ScreenColumn that was modified, which has raised the event.
		///</summary>
		///<value cref="ScreenColumn" />
		public ScreenColumn Column { get { return this.column; } }
	...
	///<summary>
	/// Define a delegate for all Screen related events.
	///</summary>
	public delegate void ScreenEventHandler(object sender, ScreenEventArgs e);
	
	#region ScreenComparer
		
	/// <summary>
	///	Strongly Typed IComparer
	/// </summary>
	public class ScreenComparer : System.Collections.Generic.IComparer<Screen>
	{
		ScreenColumn whichComparison;
		
		/// <summary>
        /// Initializes a new instance of the <see cref="T:ScreenComparer"/> class.
        /// </summary>
        ...
        public ScreenComparer(ScreenColumn column)
        {
            this.whichComparison = column;
        }

		/// <summary>
        /// Determines whether the specified <see cref="Screen"/> instances are considered equal.
        /// </summary>
        /// <param name="a">The first <see cref="Screen"/> to compare.</param>
        /// <param name="b">The second <c>Screen</c> to compare.</param>
        /// <returns>true if objA is the same instance as objB or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
        public bool Equals(Screen a, Screen b)
        {
        ...
        /// <returns></returns>
        public int GetHashCode(Screen entity)
        {
        ...
        public ScreenColumn WhichComparison
        {
	...
	#region ScreenKey Class

	/// <summary>
	/// Wraps the unique identifier values for the <see cref="Screen"/> object.
	/// </summary>
	[Serializable]
	[CLSCompliant(true)]
	public class ScreenKey : EntityKeyBase
	{
		#region Constructors
		...
		/// Initializes a new instance of the ScreenKey class.
		/// </summary>
		public ScreenKey(ScreenBase entity)
		{
			this.Entity = entity;
		...
		private ScreenBase _entity;
		
		/// <summary>
		/// Gets or sets the Entity property.
		/// </summary>
		public ScreenBase Entity
		{
			get { return _entity; }
			set { _entity = value; }
		}
	...
	#region ScreenColumn Enum
	
	/// <summary>
	/// Enumerate the Screen columns.
	/// </summary>
	[Serializable]

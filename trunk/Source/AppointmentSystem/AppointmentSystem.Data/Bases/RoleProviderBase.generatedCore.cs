...
{	
	...
	///</summary>
	public abstract partial class RoleProviderBaseCore : EntityProviderBase<AppointmentSystem.Entities.Role, AppointmentSystem.Entities.RoleKey>
	{		
		...
		public override bool Delete(TransactionManager transactionManager, AppointmentSystem.Entities.RoleKey key)
		{
		...
		public override AppointmentSystem.Entities.Role Get(TransactionManager transactionManager, AppointmentSystem.Entities.RoleKey key, int start, int pageLength)
		{
		...
		/// <returns>Returns an instance of the <see cref="AppointmentSystem.Entities.Role"/> class.</returns>
		public AppointmentSystem.Entities.Role GetById(System.String _id)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AppointmentSystem.Entities.Role"/> class.</returns>
		public AppointmentSystem.Entities.Role GetById(System.String _id, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AppointmentSystem.Entities.Role"/> class.</returns>
		public AppointmentSystem.Entities.Role GetById(TransactionManager transactionManager, System.String _id)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AppointmentSystem.Entities.Role"/> class.</returns>
		public AppointmentSystem.Entities.Role GetById(TransactionManager transactionManager, System.String _id, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="AppointmentSystem.Entities.Role"/> class.</returns>
		public AppointmentSystem.Entities.Role GetById(System.String _id, int start, int pageLength, out int count)
		{
			return GetById(null, _id, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="AppointmentSystem.Entities.Role"/> class.</returns>
		public abstract AppointmentSystem.Entities.Role GetById(TransactionManager transactionManager, System.String _id, int start, int pageLength, out int count);
		...
		public static TList<Role> Fill(IDataReader reader, TList<Role> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				AppointmentSystem.Entities.Role c = null;
				if (useEntityFactory)
				{
					key = new System.Text.StringBuilder("Role")
					.Append("|").Append((System.String)reader[((int)RoleColumn.Id - 1)]).ToString();
				...
				{
					c = new AppointmentSystem.Entities.Role();
				}
					...
					))
				{
					...
					c.Id = (System.String)reader[((int)RoleColumn.Id - 1)];
					c.OriginalId = c.Id;
					...
					c.IsLocked = (System.Boolean)reader[((int)RoleColumn.IsLocked - 1)];
					c.IsDisabled = (System.Boolean)reader[((int)RoleColumn.IsDisabled - 1)];
					c.CreateUser = (reader.IsDBNull(((int)RoleColumn.CreateUser - 1)))?null:(System.String)reader[((int)RoleColumn.CreateUser - 1)];
					c.CreateDate = (System.DateTime)reader[((int)RoleColumn.CreateDate - 1)];
					c.UpdateUser = (reader.IsDBNull(((int)RoleColumn.UpdateUser - 1)))?null:(System.String)reader[((int)RoleColumn.UpdateUser - 1)];
					c.UpdateDate = (System.DateTime)reader[((int)RoleColumn.UpdateDate - 1)];
		...
		/// <summary>
		/// Refreshes the <see cref="AppointmentSystem.Entities.Role"/> object from the <see cref="IDataReader"/>.
		/// </summary>
		/// <param name="reader">The <see cref="IDataReader"/> to read from.</param>
		/// <param name="entity">The <see cref="AppointmentSystem.Entities.Role"/> object to refresh.</param>
		public static void RefreshEntity(IDataReader reader, AppointmentSystem.Entities.Role entity)
		{
			if (!reader.Read()) return;
			
			entity.Id = (System.String)reader[((int)RoleColumn.Id - 1)];
			...
			entity.IsLocked = (System.Boolean)reader[((int)RoleColumn.IsLocked - 1)];
			entity.IsDisabled = (System.Boolean)reader[((int)RoleColumn.IsDisabled - 1)];
			entity.CreateUser = (reader.IsDBNull(((int)RoleColumn.CreateUser - 1)))?null:(System.String)reader[((int)RoleColumn.CreateUser - 1)];
			entity.CreateDate = (System.DateTime)reader[((int)RoleColumn.CreateDate - 1)];
			entity.UpdateUser = (reader.IsDBNull(((int)RoleColumn.UpdateUser - 1)))?null:(System.String)reader[((int)RoleColumn.UpdateUser - 1)];
			entity.UpdateDate = (System.DateTime)reader[((int)RoleColumn.UpdateDate - 1)];
			entity.AcceptChanges();
		}
		
		/// <summary>
		/// Refreshes the <see cref="AppointmentSystem.Entities.Role"/> object from the <see cref="DataSet"/>.
		/// </summary>
		/// <param name="dataSet">The <see cref="DataSet"/> to read from.</param>
		/// <param name="entity">The <see cref="AppointmentSystem.Entities.Role"/> object.</param>
		public static void RefreshEntity(DataSet dataSet, AppointmentSystem.Entities.Role entity)
		{
		...
		/// </remarks>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">The <see cref="AppointmentSystem.Entities.Role"/> object to load.</param>
		/// <param name="deep">Boolean. A flag that indicates whether to recursively save all Property Collection that are descendants of this instance. If True, saves the complete object graph below this object. If False, saves this object only. </param>
		/// <param name="deepLoadType">DeepLoadType Enumeration to Include/Exclude object property collections from Load.</param>
		/// <param name="childTypes">AppointmentSystem.Entities.Role Property Collection Type Array To Include or Exclude from Load</param>
		/// <param name="innerList">A collection of child types for easy access.</param>
	    /// <exception cref="ArgumentNullException">entity or childTypes is null.</exception>
	    /// <exception cref="ArgumentException">deepLoadType has invalid value.</exception>
		public override void DeepLoad(TransactionManager transactionManager, AppointmentSystem.Entities.Role entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			if(entity == null)
				return;
			...
			if (CanDeepLoad(entity, "List<GroupRole>|GroupRoleCollection", deepLoadType, innerList)) 
			{
				...
				entity.GroupRoleCollection = DataRepository.GroupRoleProvider.GetByRoleId(transactionManager, entity.Id);
			...
			if (CanDeepLoad(entity, "List<UserRole>|UserRoleCollection", deepLoadType, innerList)) 
			{
				...
				entity.UserRoleCollection = DataRepository.UserRoleProvider.GetByRoleId(transactionManager, entity.Id);
		...
		/// <summary>
		/// Deep Save the entire object graph of the AppointmentSystem.Entities.Role object with criteria based of the child 
		/// Type property array and DeepSaveType.
		/// </summary>
		/// <param name="transactionManager">The transaction manager.</param>
		/// <param name="entity">AppointmentSystem.Entities.Role instance</param>
		/// <param name="deepSaveType">DeepSaveType Enumeration to Include/Exclude object property collections from Save.</param>
		/// <param name="childTypes">AppointmentSystem.Entities.Role Property Collection Type Array To Include or Exclude from Save</param>
		/// <param name="innerList">A Hashtable of child types for easy access.</param>
		public override bool DeepSave(TransactionManager transactionManager, AppointmentSystem.Entities.Role entity, DeepSaveType deepSaveType, System.Type[] childTypes, DeepSession innerList)
		{	
			if (entity == null)
				return false;
	...
	/// for child properties in <c>AppointmentSystem.Entities.Role</c>
	///</summary>

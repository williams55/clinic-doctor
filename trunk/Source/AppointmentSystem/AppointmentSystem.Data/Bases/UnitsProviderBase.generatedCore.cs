...
{	
	...
	{		
		...
		public static TList<Units> Fill(IDataReader reader, TList<Units> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.Users = (reader.IsDBNull(((int)UnitsColumn.Users - 1)))?null:(System.String)reader[((int)UnitsColumn.Users - 1)];
		...
		public static void RefreshEntity(IDataReader reader, AppointmentSystem.Entities.Units entity)
		{
			...
			entity.Users = (reader.IsDBNull(((int)UnitsColumn.Users - 1)))?null:(System.String)reader[((int)UnitsColumn.Users - 1)];
		...
		public static void RefreshEntity(DataSet dataSet, AppointmentSystem.Entities.Units entity)
		{
			...
			entity.Users = Convert.IsDBNull(dataRow["Users"]) ? null : (System.String)dataRow["Users"];

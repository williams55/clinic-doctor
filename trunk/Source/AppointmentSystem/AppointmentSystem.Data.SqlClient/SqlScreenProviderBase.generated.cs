...
/*
	...
	Important: Do not modify this file. Edit the file SqlScreenProvider.cs instead.
*/
...
namespace AppointmentSystem.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlScreenProviderBase : ScreenProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlScreenProviderBase"/> instance.
		/// </summary>
		public SqlScreenProviderBase()
		{
		}
	...
	public SqlScreenProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		/// <summary>
		/// 	Inserts a AppointmentSystem.Entities.Screen object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">AppointmentSystem.Entities.Screen object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the AppointmentSystem.Entities.Screen object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, AppointmentSystem.Entities.Screen entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);

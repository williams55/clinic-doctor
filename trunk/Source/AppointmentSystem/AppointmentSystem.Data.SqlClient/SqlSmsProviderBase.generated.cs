/*
	...
	Important: Do not modify this file. Edit the file SqlSmsProvider.cs instead.
*/
...
namespace AppointmentSystem.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlSmsProviderBase : SmsProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlSmsProviderBase"/> instance.
		/// </summary>
		public SqlSmsProviderBase()
		{
		}
	...
	public SqlSmsProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Int64 _id)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Sms_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(Sms)
					,_id);
		...
		public override TList<Sms> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<Sms>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Sms_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@SmsType", DbType.Byte, DBNull.Value);
		database.AddInParameter(commandWrapper, "@SendTime", DbType.DateTime, DBNull.Value);
		database.AddInParameter(commandWrapper, "@IsSendNow", DbType.Boolean, DBNull.Value);
		database.AddInParameter(commandWrapper, "@IsSent", DbType.Boolean, DBNull.Value);
		database.AddInParameter(commandWrapper, "@SendingTimes", DbType.Int32, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@UpdateDate", DbType.DateTime, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("smstype ") || clause.Trim().StartsWith("smstype="))
				{
					database.SetParameterValue(commandWrapper, "@SmsType", 
						clause.Trim().Remove(0,7).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("sendtime ") || clause.Trim().StartsWith("sendtime="))
				{
					database.SetParameterValue(commandWrapper, "@SendTime", 
						clause.Trim().Remove(0,8).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("issendnow ") || clause.Trim().StartsWith("issendnow="))
				{
					database.SetParameterValue(commandWrapper, "@IsSendNow", 
						clause.Trim().Remove(0,9).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("issent ") || clause.Trim().StartsWith("issent="))
				{
					database.SetParameterValue(commandWrapper, "@IsSent", 
						clause.Trim().Remove(0,6).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("sendingtimes ") || clause.Trim().StartsWith("sendingtimes="))
				{
					database.SetParameterValue(commandWrapper, "@SendingTimes", 
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of AppointmentSystem.Entities.Sms objects.</returns>
		public override TList<Sms> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Sms_Find_Dynamic", typeof(SmsColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<Sms> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Sms_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of AppointmentSystem.Entities.Sms objects.</returns>
		public override TList<Sms> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Sms_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<Sms> GetByAppointmentId(TransactionManager transactionManager, System.String _appointmentId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Sms_GetByAppointmentId", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override AppointmentSystem.Entities.Sms GetById(TransactionManager transactionManager, System.Int64 _id, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Sms_GetById", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@Id", DbType.Int64, _id);
			
			IDataReader reader = null;
			TList<Sms> tmp = new TList<Sms>();
			try
			{
				//Provider Data Requesting Command Event
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<AppointmentSystem.Entities.Sms> entities)
		{
			...
			DataColumn col1 = dataTable.Columns.Add("Message", typeof(System.String));
			col1.AllowDBNull = true;		
			DataColumn col2 = dataTable.Columns.Add("SmsType", typeof(System.Byte));
			col2.AllowDBNull = false;		
			DataColumn col3 = dataTable.Columns.Add("SendTime", typeof(System.DateTime));
			col3.AllowDBNull = false;		
			DataColumn col4 = dataTable.Columns.Add("IsSendNow", typeof(System.Boolean));
			col4.AllowDBNull = false;		
			DataColumn col5 = dataTable.Columns.Add("IsSent", typeof(System.Boolean));
			col5.AllowDBNull = false;		
			DataColumn col6 = dataTable.Columns.Add("SendingTimes", typeof(System.Int32));
			col6.AllowDBNull = false;		
			DataColumn col7 = dataTable.Columns.Add("AppointmentId", typeof(System.String));
			...
			bulkCopy.ColumnMappings.Add("SmsType", "SmsType");
			bulkCopy.ColumnMappings.Add("SendTime", "SendTime");
			bulkCopy.ColumnMappings.Add("IsSendNow", "IsSendNow");
			...
			foreach(AppointmentSystem.Entities.Sms entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["SmsType"] = entity.SmsType;
							
				
					row["SendTime"] = entity.SendTime;
							
				
					row["IsSendNow"] = entity.IsSendNow;
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">AppointmentSystem.Entities.Sms object to update.</param>
		/// <remarks>
		///		After updating the datasource, the AppointmentSystem.Entities.Sms object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, AppointmentSystem.Entities.Sms entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.Sms_Update", _useStoredProcedure);

...
/// <summary>
/// Summary description for AppointmentCalendar
/// </summary>
public class AppointmentCalendar
{
    ...
    public virtual void AddAttendee(string AttendeeEmail, string AttendeeName)
    {
        MailAddress Attendee = new MailAddress(AttendeeEmail, AttendeeName);
    ...
    #region Variables
    public DateTime StartDate = DateTime.Now.AddMinutes(10);
    public DateTime EndDate = DateTime.Now.AddMinutes(20);
    public string Subject = "Sending an appointment";
    public string Summary = "This mail is just a test mail";
    public string Location = "Việt Nam";
    public MailAddressCollection AttendeeList;
    public string OrganizerName = "Vo Phat";
    public string OrganizerEmail = "votienphat@gmail.com";

    public List<Attachment> Attachments;

    public Guid MeetingGUID;

    public string Directory = "depdut";

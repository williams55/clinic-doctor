...
/*
	...
	Important: Do not modify this file. Edit the file SqlDoctorRosterProvider.cs instead.
*/
...
namespace ClinicDoctor.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlDoctorRosterProviderBase : DoctorRosterProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlDoctorRosterProviderBase"/> instance.
		/// </summary>
		public SqlDoctorRosterProviderBase()
		{
		}
	...
	public SqlDoctorRosterProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.String _id)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(DoctorRoster)
					,_id);
		...
		public override TList<DoctorRoster> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<DoctorRoster>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@UpdateDate", DbType.DateTime, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				{
					database.SetParameterValue(commandWrapper, "@RosterTypeId", 
						clause.Trim().Remove(0,12).Trim().TrimStart(equalSign).Trim().Trim(singleQuote));
					continue;
				}
				if (clause.Trim().StartsWith("rostertypetitle ") || clause.Trim().StartsWith("rostertypetitle="))
				{
			...
			//Create Collection
			TList<DoctorRoster> rows = new TList<DoctorRoster>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of ClinicDoctor.Entities.DoctorRoster objects.</returns>
		public override TList<DoctorRoster> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_Find_Dynamic", typeof(DoctorRosterColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<DoctorRoster> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of ClinicDoctor.Entities.DoctorRoster objects.</returns>
		public override TList<DoctorRoster> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<DoctorRoster> GetByDoctorUserName(TransactionManager transactionManager, System.String _doctorUserName, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_GetByDoctorUserName", _useStoredProcedure);
		...
		#region GetByDoctorUserNameIsComplete
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<DoctorRoster> GetByDoctorUserNameIsComplete(TransactionManager transactionManager, System.String _doctorUserName, System.Boolean _isComplete, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_GetByDoctorUserNameIsComplete", _useStoredProcedure);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByDoctorUserNameIsComplete", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByDoctorUserNameIsComplete", tmp));
			}
			finally 
			{
				if (reader != null) 
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<DoctorRoster> GetByDoctorUserNameIsCompleteIsDisabled(TransactionManager transactionManager, System.String _doctorUserName, System.Boolean _isComplete, System.Boolean _isDisabled, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_GetByDoctorUserNameIsCompleteIsDisabled", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<DoctorRoster> GetByDoctorUserNameIsDisabled(TransactionManager transactionManager, System.String _doctorUserName, System.Boolean _isDisabled, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_GetByDoctorUserNameIsDisabled", _useStoredProcedure);
		...
		#region GetByDoctorUserNameRosterTypeId
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<DoctorRoster> GetByDoctorUserNameRosterTypeId(TransactionManager transactionManager, System.String _doctorUserName, System.Int64 _rosterTypeId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_GetByDoctorUserNameRosterTypeId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@DoctorUserName", DbType.String, _doctorUserName);
				database.AddInParameter(commandWrapper, "@RosterTypeId", DbType.Int64, _rosterTypeId);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByDoctorUserNameRosterTypeId", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByDoctorUserNameRosterTypeId", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		#region GetByDoctorUserNameRosterTypeIdIsComplete
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<DoctorRoster> GetByDoctorUserNameRosterTypeIdIsComplete(TransactionManager transactionManager, System.String _doctorUserName, System.Int64 _rosterTypeId, System.Boolean _isComplete, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_GetByDoctorUserNameRosterTypeIdIsComplete", _useStoredProcedure);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByDoctorUserNameRosterTypeIdIsComplete", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByDoctorUserNameRosterTypeIdIsComplete", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		#region GetByDoctorUserNameRosterTypeIdIsCompleteIsDisabled
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<DoctorRoster> GetByDoctorUserNameRosterTypeIdIsCompleteIsDisabled(TransactionManager transactionManager, System.String _doctorUserName, System.Int64 _rosterTypeId, System.Boolean _isComplete, System.Boolean _isDisabled, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_GetByDoctorUserNameRosterTypeIdIsCompleteIsDisabled", _useStoredProcedure);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByDoctorUserNameRosterTypeIdIsCompleteIsDisabled", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByDoctorUserNameRosterTypeIdIsCompleteIsDisabled", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		#region GetByDoctorUserNameRosterTypeIdIsDisabled
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<DoctorRoster> GetByDoctorUserNameRosterTypeIdIsDisabled(TransactionManager transactionManager, System.String _doctorUserName, System.Int64 _rosterTypeId, System.Boolean _isDisabled, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_GetByDoctorUserNameRosterTypeIdIsDisabled", _useStoredProcedure);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByDoctorUserNameRosterTypeIdIsDisabled", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByDoctorUserNameRosterTypeIdIsDisabled", tmp));
			}
			finally 
			{
				if (reader != null) 
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override ClinicDoctor.Entities.DoctorRoster GetByIdIsComplete(TransactionManager transactionManager, System.String _id, System.Boolean _isComplete, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_GetByIdIsComplete", _useStoredProcedure);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByIdIsComplete", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByIdIsComplete", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		#region GetByIdIsCompleteIsDisabled
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override ClinicDoctor.Entities.DoctorRoster GetByIdIsCompleteIsDisabled(TransactionManager transactionManager, System.String _id, System.Boolean _isComplete, System.Boolean _isDisabled, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_GetByIdIsCompleteIsDisabled", _useStoredProcedure);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByIdIsCompleteIsDisabled", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByIdIsCompleteIsDisabled", tmp));
			}
			finally 
			{
				if (reader != null) 
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override ClinicDoctor.Entities.DoctorRoster GetByIdIsDisabled(TransactionManager transactionManager, System.String _id, System.Boolean _isDisabled, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_GetByIdIsDisabled", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<DoctorRoster> GetByIsDisabled(TransactionManager transactionManager, System.Boolean _isDisabled, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_GetByIsDisabled", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<DoctorRoster> GetByRosterTypeId(TransactionManager transactionManager, System.Int64 _rosterTypeId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_GetByRosterTypeId", _useStoredProcedure);
		...
		#region GetByRosterTypeIdIsComplete
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<DoctorRoster> GetByRosterTypeIdIsComplete(TransactionManager transactionManager, System.Int64 _rosterTypeId, System.Boolean _isComplete, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_GetByRosterTypeIdIsComplete", _useStoredProcedure);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByRosterTypeIdIsComplete", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByRosterTypeIdIsComplete", tmp));
			}
			finally 
			{
				if (reader != null) 
		...
		#region GetByRosterTypeIdIsCompleteIsDisabled
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<DoctorRoster> GetByRosterTypeIdIsCompleteIsDisabled(TransactionManager transactionManager, System.Int64 _rosterTypeId, System.Boolean _isComplete, System.Boolean _isDisabled, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_GetByRosterTypeIdIsCompleteIsDisabled", _useStoredProcedure);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetByRosterTypeIdIsCompleteIsDisabled", tmp)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetByRosterTypeIdIsCompleteIsDisabled", tmp));
			}
			finally 
			{
				if (reader != null) 
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override ClinicDoctor.Entities.DoctorRoster GetById(TransactionManager transactionManager, System.String _id, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_GetById", _useStoredProcedure);
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<ClinicDoctor.Entities.DoctorRoster> entities)
		{
			...
			bulkCopy.DestinationTableName = "DoctorRoster";
			...
			foreach(ClinicDoctor.Entities.DoctorRoster entity in entities)
			{
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, ClinicDoctor.Entities.DoctorRoster entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.DoctorRoster_Update", _useStoredProcedure);

...
<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="RoomFunc.aspx.cs" Inherits="Admin_RoomFunc" Title="RoomFunc List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridView1" runat="server"			
				...
				DataSourceID="RoomFuncDataSource"
				DataKeyNames="Id"
		...
		<br />
		<asp:Button runat="server" ID="btnRoomFunc" OnClientClick="javascript:location.href='RoomFuncEdit.aspx'; return false;" Text="Add New"></asp:Button>

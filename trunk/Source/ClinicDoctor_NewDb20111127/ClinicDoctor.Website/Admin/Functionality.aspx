...
<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="Functionality.aspx.cs" Inherits="Admin_Functionality" Title="Functionality List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridView1" runat="server"			
				...
				DataSourceID="FunctionalityDataSource"
				DataKeyNames="Id"
		...
		<br />
		<asp:Button runat="server" ID="btnFunctionality" OnClientClick="javascript:location.href='FunctionalityEdit.aspx'; return false;" Text="Add New"></asp:Button>

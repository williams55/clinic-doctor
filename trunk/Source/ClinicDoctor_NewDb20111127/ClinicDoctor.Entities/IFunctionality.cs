...
{
	/// <summary>
	///		The data structure representation of the 'Functionality' table via interface.
	/// </summary>
	/// <remarks>
	...
	public interface IFunctionality 
	{
		...
		/// </summary>	
		TList<Content> ContentCollection {  get;  set;}	
		...
		/// </summary>	
		TList<RoomFunc> RoomFuncCollection {  get;  set;}	

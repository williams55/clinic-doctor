...
{	
	...
	{		
		...
		public static TList<Customer> Fill(IDataReader reader, TList<Customer> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.IsFemale = (System.Boolean)reader[((int)CustomerColumn.IsFemale - 1)];
		...
		public static void RefreshEntity(IDataReader reader, ClinicDoctor.Entities.Customer entity)
		{
			...
			entity.IsFemale = (System.Boolean)reader[((int)CustomerColumn.IsFemale - 1)];
			...
			entity.IsDisabled = (System.Boolean)reader[((int)CustomerColumn.IsDisabled - 1)];
			...
			entity.CreateDate = (System.DateTime)reader[((int)CustomerColumn.CreateDate - 1)];
			...
			entity.UpdateDate = (System.DateTime)reader[((int)CustomerColumn.UpdateDate - 1)];

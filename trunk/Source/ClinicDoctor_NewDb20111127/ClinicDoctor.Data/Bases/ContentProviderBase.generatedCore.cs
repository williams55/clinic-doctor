...
{	
	...
	{		
		...
		public static TList<Content> Fill(IDataReader reader, TList<Content> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
					...
					))
				{
					...
					c.ColorCode = (reader.IsDBNull(((int)ContentColumn.ColorCode - 1)))?null:(System.String)reader[((int)ContentColumn.ColorCode - 1)];
		...
		public static void RefreshEntity(IDataReader reader, ClinicDoctor.Entities.Content entity)
		{
			...
			entity.ColorCode = (reader.IsDBNull(((int)ContentColumn.ColorCode - 1)))?null:(System.String)reader[((int)ContentColumn.ColorCode - 1)];

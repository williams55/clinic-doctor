...
{	
	...
	{		
		...
		public ClinicDoctor.Entities.Staff GetByIdIsDisabled(System.Int64 _id, System.Boolean _isDisabled)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Staff"/> class.</returns>
		public ClinicDoctor.Entities.Staff GetByIdIsDisabled(System.Int64 _id, System.Boolean _isDisabled, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Staff"/> class.</returns>
		public ClinicDoctor.Entities.Staff GetByIdIsDisabled(TransactionManager transactionManager, System.Int64 _id, System.Boolean _isDisabled)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Staff"/> class.</returns>
		public ClinicDoctor.Entities.Staff GetByIdIsDisabled(TransactionManager transactionManager, System.Int64 _id, System.Boolean _isDisabled, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Staff"/> class.</returns>
		public ClinicDoctor.Entities.Staff GetByIdIsDisabled(System.Int64 _id, System.Boolean _isDisabled, int start, int pageLength, out int count)
		{
			return GetByIdIsDisabled(null, _id, _isDisabled, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Staff"/> class.</returns>
		public abstract ClinicDoctor.Entities.Staff GetByIdIsDisabled(TransactionManager transactionManager, System.Int64 _id, System.Boolean _isDisabled, int start, int pageLength, out int count);
		...
		/// <param name="_id"></param>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Staff"/> class.</returns>
		public ClinicDoctor.Entities.Staff GetById(System.Int64 _id)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Staff"/> class.</returns>
		public ClinicDoctor.Entities.Staff GetById(System.Int64 _id, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Staff"/> class.</returns>
		public ClinicDoctor.Entities.Staff GetById(TransactionManager transactionManager, System.Int64 _id)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Staff"/> class.</returns>
		public ClinicDoctor.Entities.Staff GetById(TransactionManager transactionManager, System.Int64 _id, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Staff"/> class.</returns>
		public ClinicDoctor.Entities.Staff GetById(System.Int64 _id, int start, int pageLength, out int count)
		{
			return GetById(null, _id, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Staff"/> class.</returns>
		public abstract ClinicDoctor.Entities.Staff GetById(TransactionManager transactionManager, System.Int64 _id, int start, int pageLength, out int count);
		...
		public static TList<Staff> Fill(IDataReader reader, TList<Staff> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				if (useEntityFactory)
				{
					...
					.Append("|").Append((System.Int64)reader[((int)StaffColumn.Id - 1)]).ToString();
					...
					))
				{
					...
					c.Id = (System.Int64)reader[((int)StaffColumn.Id - 1)];
					...
					c.IsFemale = (System.Boolean)reader[((int)StaffColumn.IsFemale - 1)];
					...
					c.Roles = (System.String)reader[((int)StaffColumn.Roles - 1)];
					c.IsDisabled = (System.Boolean)reader[((int)StaffColumn.IsDisabled - 1)];
					c.CreateUser = (reader.IsDBNull(((int)StaffColumn.CreateUser - 1)))?null:(System.String)reader[((int)StaffColumn.CreateUser - 1)];
					c.CreateDate = (System.DateTime)reader[((int)StaffColumn.CreateDate - 1)];
					c.UpdateUser = (reader.IsDBNull(((int)StaffColumn.UpdateUser - 1)))?null:(System.String)reader[((int)StaffColumn.UpdateUser - 1)];
					c.UpdateDate = (System.DateTime)reader[((int)StaffColumn.UpdateDate - 1)];
		...
		public static void RefreshEntity(IDataReader reader, ClinicDoctor.Entities.Staff entity)
		{
			...
			entity.Id = (System.Int64)reader[((int)StaffColumn.Id - 1)];
			...
			entity.IsFemale = (System.Boolean)reader[((int)StaffColumn.IsFemale - 1)];
			...
			entity.Roles = (System.String)reader[((int)StaffColumn.Roles - 1)];
			entity.IsDisabled = (System.Boolean)reader[((int)StaffColumn.IsDisabled - 1)];
			entity.CreateUser = (reader.IsDBNull(((int)StaffColumn.CreateUser - 1)))?null:(System.String)reader[((int)StaffColumn.CreateUser - 1)];
			entity.CreateDate = (System.DateTime)reader[((int)StaffColumn.CreateDate - 1)];
			entity.UpdateUser = (reader.IsDBNull(((int)StaffColumn.UpdateUser - 1)))?null:(System.String)reader[((int)StaffColumn.UpdateUser - 1)];
			entity.UpdateDate = (System.DateTime)reader[((int)StaffColumn.UpdateDate - 1)];
		...
		public static void RefreshEntity(DataSet dataSet, ClinicDoctor.Entities.Staff entity)
		{
			...
			entity.Roles = (System.String)dataRow["Roles"];
		...
		public override void DeepLoad(TransactionManager transactionManager, ClinicDoctor.Entities.Staff entity, bool deep, DeepLoadType deepLoadType, System.Type[] childTypes, DeepSession innerList)
		{
			...
			//Relationship Type One : Many
			if (CanDeepLoad(entity, "List<Appointment>|AppointmentCollectionGetByNurseId", deepLoadType, innerList)) 
			{
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'AppointmentCollectionGetByNurseId' loaded. key " + entity.EntityTrackingKey);
				#endif 

				entity.AppointmentCollectionGetByNurseId = DataRepository.AppointmentProvider.GetByNurseId(transactionManager, entity.Id);

				if (deep && entity.AppointmentCollectionGetByNurseId.Count > 0)
				{
					deepHandles.Add("AppointmentCollectionGetByNurseId",
						new KeyValuePair<Delegate, object>((DeepLoadHandle<Appointment>) DataRepository.AppointmentProvider.DeepLoad,
						new object[] { transactionManager, entity.AppointmentCollectionGetByNurseId, deep, deepLoadType, childTypes, innerList }
					));
				}
			}		
			#endregion 
			...
			//Relationship Type One : Many
			if (CanDeepLoad(entity, "List<Appointment>|AppointmentCollectionGetByDoctorId", deepLoadType, innerList)) 
			{
				#if NETTIERS_DEBUG
				System.Diagnostics.Debug.WriteLine("- property 'AppointmentCollectionGetByDoctorId' loaded. key " + entity.EntityTrackingKey);
				#endif 

				entity.AppointmentCollectionGetByDoctorId = DataRepository.AppointmentProvider.GetByDoctorId(transactionManager, entity.Id);

				if (deep && entity.AppointmentCollectionGetByDoctorId.Count > 0)
				{
					deepHandles.Add("AppointmentCollectionGetByDoctorId",
						new KeyValuePair<Delegate, object>((DeepLoadHandle<Appointment>) DataRepository.AppointmentProvider.DeepLoad,
						new object[] { transactionManager, entity.AppointmentCollectionGetByDoctorId, deep, deepLoadType, childTypes, innerList }
					));
				}
			}		
			#endregion 
		...
		{	
			...
			#region List<Appointment>
				if (CanDeepSave(entity.AppointmentCollectionGetByNurseId, "List<Appointment>|AppointmentCollectionGetByNurseId", deepSaveType, innerList)) 
				{	
					// update each child parent id with the real parent id (mostly used on insert)
					foreach(Appointment child in entity.AppointmentCollectionGetByNurseId)
					{
					...
					if (entity.AppointmentCollectionGetByNurseId.Count > 0 || entity.AppointmentCollectionGetByNurseId.DeletedItems.Count > 0)
					{
						//DataRepository.AppointmentProvider.Save(transactionManager, entity.AppointmentCollectionGetByNurseId);
						
						deepHandles.Add("AppointmentCollectionGetByNurseId",
						new KeyValuePair<Delegate, object>((DeepSaveHandle< Appointment >) DataRepository.AppointmentProvider.DeepSave,
							new object[] { transactionManager, entity.AppointmentCollectionGetByNurseId, deepSaveType, childTypes, innerList }
						));
					}
				} 
			#endregion 
			...
			#region List<Appointment>
				if (CanDeepSave(entity.AppointmentCollectionGetByDoctorId, "List<Appointment>|AppointmentCollectionGetByDoctorId", deepSaveType, innerList)) 
				{	
					// update each child parent id with the real parent id (mostly used on insert)
					foreach(Appointment child in entity.AppointmentCollectionGetByDoctorId)
					{
						if(child.DoctorIdSource != null)
						{
							child.DoctorId = child.DoctorIdSource.Id;
					...
					if (entity.AppointmentCollectionGetByDoctorId.Count > 0 || entity.AppointmentCollectionGetByDoctorId.DeletedItems.Count > 0)
					{
						//DataRepository.AppointmentProvider.Save(transactionManager, entity.AppointmentCollectionGetByDoctorId);
						
						deepHandles.Add("AppointmentCollectionGetByDoctorId",
						new KeyValuePair<Delegate, object>((DeepSaveHandle< Appointment >) DataRepository.AppointmentProvider.DeepSave,
							new object[] { transactionManager, entity.AppointmentCollectionGetByDoctorId, deepSaveType, childTypes, innerList }
						));
					}
				} 
			#endregion 
	...
	public enum StaffChildEntityTypes
	{
		...
		AppointmentCollectionGetByNurseId,

		///<summary>
		/// Collection of <c>Staff</c> as OneToMany for AppointmentCollection
		///</summary>
		[ChildEntityType(typeof(TList<Appointment>))]
		AppointmentCollectionGetByDoctorId,

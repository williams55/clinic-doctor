...
<asp:Content ID="Content" runat="server" ContentPlaceHolderID="TreeContentPlaceholder">
    ...
    --%><script>
        ...
        tree.loadXML("customActions.ashx");
        var dp = new dataProcessor("customActions.ashx");
        dp.setUpdateMode("off");
        dp.init(tree);
        dp.defineAction("sayHello", function(node) {
            alert("Server says: " + node.firstChild.data);
        });
    </script>

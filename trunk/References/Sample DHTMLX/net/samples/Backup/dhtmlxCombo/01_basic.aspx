...
<asp:Content ID="MainContent" ContentPlaceHolderID="ComboContentPlaceholder" runat="server">
    <script type="text/javascript">
        ...
        z.loadXML("01_basic_connector.ashx");

        var z = new dhtmlXCombo("combo_zone5", "alfa4", 200);
        z.enableFilteringMode(true, "01_basic_connector.ashx", true);

        var z = new dhtmlXCombo("combo_zone6", "alfa4", 200);
        z.enableFilteringMode(true, "01_basic_connector.ashx?dynamic=true", true, true);
    </script>
</asp:Content>

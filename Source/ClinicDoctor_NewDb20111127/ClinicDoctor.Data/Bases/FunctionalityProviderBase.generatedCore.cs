...
{	
	...
	{		
		...
		public ClinicDoctor.Entities.Functionality GetByIdIsDisabled(System.Int64 _id, System.Boolean _isDisabled)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Functionality"/> class.</returns>
		public ClinicDoctor.Entities.Functionality GetByIdIsDisabled(System.Int64 _id, System.Boolean _isDisabled, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Functionality"/> class.</returns>
		public ClinicDoctor.Entities.Functionality GetByIdIsDisabled(TransactionManager transactionManager, System.Int64 _id, System.Boolean _isDisabled)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Functionality"/> class.</returns>
		public ClinicDoctor.Entities.Functionality GetByIdIsDisabled(TransactionManager transactionManager, System.Int64 _id, System.Boolean _isDisabled, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Functionality"/> class.</returns>
		public ClinicDoctor.Entities.Functionality GetByIdIsDisabled(System.Int64 _id, System.Boolean _isDisabled, int start, int pageLength, out int count)
		{
			return GetByIdIsDisabled(null, _id, _isDisabled, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Functionality"/> class.</returns>
		public abstract ClinicDoctor.Entities.Functionality GetByIdIsDisabled(TransactionManager transactionManager, System.Int64 _id, System.Boolean _isDisabled, int start, int pageLength, out int count);
		...
		/// <param name="_id"></param>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Functionality"/> class.</returns>
		public ClinicDoctor.Entities.Functionality GetById(System.Int64 _id)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Functionality"/> class.</returns>
		public ClinicDoctor.Entities.Functionality GetById(System.Int64 _id, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Functionality"/> class.</returns>
		public ClinicDoctor.Entities.Functionality GetById(TransactionManager transactionManager, System.Int64 _id)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Functionality"/> class.</returns>
		public ClinicDoctor.Entities.Functionality GetById(TransactionManager transactionManager, System.Int64 _id, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Functionality"/> class.</returns>
		public ClinicDoctor.Entities.Functionality GetById(System.Int64 _id, int start, int pageLength, out int count)
		{
			return GetById(null, _id, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Functionality"/> class.</returns>
		public abstract ClinicDoctor.Entities.Functionality GetById(TransactionManager transactionManager, System.Int64 _id, int start, int pageLength, out int count);
		...
		public static TList<Functionality> Fill(IDataReader reader, TList<Functionality> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				if (useEntityFactory)
				{
					...
					.Append("|").Append((System.Int64)reader[((int)FunctionalityColumn.Id - 1)]).ToString();
					...
					))
				{
					...
					c.CreateDate = (System.DateTime)reader[((int)FunctionalityColumn.CreateDate - 1)];
					...
					c.UpdateDate = (System.DateTime)reader[((int)FunctionalityColumn.UpdateDate - 1)];
		...
		public static void RefreshEntity(IDataReader reader, ClinicDoctor.Entities.Functionality entity)
		{
			...
			entity.CreateDate = (System.DateTime)reader[((int)FunctionalityColumn.CreateDate - 1)];
			...
			entity.UpdateDate = (System.DateTime)reader[((int)FunctionalityColumn.UpdateDate - 1)];

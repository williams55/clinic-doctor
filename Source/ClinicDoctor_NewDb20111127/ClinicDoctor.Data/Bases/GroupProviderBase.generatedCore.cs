...
{	
	...
	{		
		...
		public ClinicDoctor.Entities.Group GetByIdIsDisabled(System.Int64 _id, System.Boolean _isDisabled)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Group"/> class.</returns>
		public ClinicDoctor.Entities.Group GetByIdIsDisabled(System.Int64 _id, System.Boolean _isDisabled, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Group"/> class.</returns>
		public ClinicDoctor.Entities.Group GetByIdIsDisabled(TransactionManager transactionManager, System.Int64 _id, System.Boolean _isDisabled)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Group"/> class.</returns>
		public ClinicDoctor.Entities.Group GetByIdIsDisabled(TransactionManager transactionManager, System.Int64 _id, System.Boolean _isDisabled, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Group"/> class.</returns>
		public ClinicDoctor.Entities.Group GetByIdIsDisabled(System.Int64 _id, System.Boolean _isDisabled, int start, int pageLength, out int count)
		{
			return GetByIdIsDisabled(null, _id, _isDisabled, start, pageLength, out count);
		}
		...
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Group"/> class.</returns>
		public abstract ClinicDoctor.Entities.Group GetByIdIsDisabled(TransactionManager transactionManager, System.Int64 _id, System.Boolean _isDisabled, int start, int pageLength, out int count);
		...
		/// <param name="_id"></param>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Group"/> class.</returns>
		public ClinicDoctor.Entities.Group GetById(System.Int64 _id)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Group"/> class.</returns>
		public ClinicDoctor.Entities.Group GetById(System.Int64 _id, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Group"/> class.</returns>
		public ClinicDoctor.Entities.Group GetById(TransactionManager transactionManager, System.Int64 _id)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Group"/> class.</returns>
		public ClinicDoctor.Entities.Group GetById(TransactionManager transactionManager, System.Int64 _id, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Group"/> class.</returns>
		public ClinicDoctor.Entities.Group GetById(System.Int64 _id, int start, int pageLength, out int count)
		{
			return GetById(null, _id, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Group"/> class.</returns>
		public abstract ClinicDoctor.Entities.Group GetById(TransactionManager transactionManager, System.Int64 _id, int start, int pageLength, out int count);
		...
		public static TList<Group> Fill(IDataReader reader, TList<Group> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				if (useEntityFactory)
				{
					...
					.Append("|").Append((System.Int64)reader[((int)GroupColumn.Id - 1)]).ToString();
					...
					))
				{
					...
					c.UpdateDate = (System.DateTime)reader[((int)GroupColumn.UpdateDate - 1)];
		...
		public static void RefreshEntity(IDataReader reader, ClinicDoctor.Entities.Group entity)
		{
			...
			entity.UpdateDate = (System.DateTime)reader[((int)GroupColumn.UpdateDate - 1)];

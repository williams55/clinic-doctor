...
{	
	...
	{		
		...
		public ClinicDoctor.Entities.Room GetByIdIsDisabled(System.Int64 _id, System.Boolean _isDisabled)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public ClinicDoctor.Entities.Room GetByIdIsDisabled(System.Int64 _id, System.Boolean _isDisabled, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public ClinicDoctor.Entities.Room GetByIdIsDisabled(TransactionManager transactionManager, System.Int64 _id, System.Boolean _isDisabled)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public ClinicDoctor.Entities.Room GetByIdIsDisabled(TransactionManager transactionManager, System.Int64 _id, System.Boolean _isDisabled, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public ClinicDoctor.Entities.Room GetByIdIsDisabled(System.Int64 _id, System.Boolean _isDisabled, int start, int pageLength, out int count)
		{
			return GetByIdIsDisabled(null, _id, _isDisabled, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public abstract ClinicDoctor.Entities.Room GetByIdIsDisabled(TransactionManager transactionManager, System.Int64 _id, System.Boolean _isDisabled, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key IX_Room_Id_Status index.
		/// </summary>
		/// <param name="_id"></param>
		/// <param name="_status"></param>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public ClinicDoctor.Entities.Room GetByIdStatus(System.Int64 _id, System.String _status)
		{
			int count = -1;
			return GetByIdStatus(null,_id, _status, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public ClinicDoctor.Entities.Room GetByIdStatus(System.Int64 _id, System.String _status, int start, int pageLength)
		{
			int count = -1;
			return GetByIdStatus(null, _id, _status, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public ClinicDoctor.Entities.Room GetByIdStatus(TransactionManager transactionManager, System.Int64 _id, System.String _status)
		{
			int count = -1;
			return GetByIdStatus(transactionManager, _id, _status, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public ClinicDoctor.Entities.Room GetByIdStatus(TransactionManager transactionManager, System.Int64 _id, System.String _status, int start, int pageLength)
		{
			int count = -1;
			return GetByIdStatus(transactionManager, _id, _status, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public ClinicDoctor.Entities.Room GetByIdStatus(System.Int64 _id, System.String _status, int start, int pageLength, out int count)
		{
			return GetByIdStatus(null, _id, _status, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public abstract ClinicDoctor.Entities.Room GetByIdStatus(TransactionManager transactionManager, System.Int64 _id, System.String _status, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key IX_Room_Id_Status_IsDisabled index.
		/// </summary>
		/// <param name="_id"></param>
		/// <param name="_status"></param>
		/// <param name="_isDisabled"></param>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public ClinicDoctor.Entities.Room GetByIdStatusIsDisabled(System.Int64 _id, System.String _status, System.Boolean _isDisabled)
		{
			int count = -1;
			return GetByIdStatusIsDisabled(null,_id, _status, _isDisabled, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public ClinicDoctor.Entities.Room GetByIdStatusIsDisabled(System.Int64 _id, System.String _status, System.Boolean _isDisabled, int start, int pageLength)
		{
			int count = -1;
			return GetByIdStatusIsDisabled(null, _id, _status, _isDisabled, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public ClinicDoctor.Entities.Room GetByIdStatusIsDisabled(TransactionManager transactionManager, System.Int64 _id, System.String _status, System.Boolean _isDisabled)
		{
			int count = -1;
			return GetByIdStatusIsDisabled(transactionManager, _id, _status, _isDisabled, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public ClinicDoctor.Entities.Room GetByIdStatusIsDisabled(TransactionManager transactionManager, System.Int64 _id, System.String _status, System.Boolean _isDisabled, int start, int pageLength)
		{
			int count = -1;
			return GetByIdStatusIsDisabled(transactionManager, _id, _status, _isDisabled, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public ClinicDoctor.Entities.Room GetByIdStatusIsDisabled(System.Int64 _id, System.String _status, System.Boolean _isDisabled, int start, int pageLength, out int count)
		{
			return GetByIdStatusIsDisabled(null, _id, _status, _isDisabled, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public abstract ClinicDoctor.Entities.Room GetByIdStatusIsDisabled(TransactionManager transactionManager, System.Int64 _id, System.String _status, System.Boolean _isDisabled, int start, int pageLength, out int count);
		...
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key IX_Room_Status index.
		/// </summary>
		/// <param name="_status"></param>
		/// <returns>Returns an instance of the <see cref="TList&lt;Room&gt;"/> class.</returns>
		public TList<Room> GetByStatus(System.String _status)
		{
			int count = -1;
			return GetByStatus(null,_status, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;Room&gt;"/> class.</returns>
		public TList<Room> GetByStatus(System.String _status, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;Room&gt;"/> class.</returns>
		public TList<Room> GetByStatus(TransactionManager transactionManager, System.String _status)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;Room&gt;"/> class.</returns>
		public TList<Room> GetByStatus(TransactionManager transactionManager, System.String _status, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;Room&gt;"/> class.</returns>
		public TList<Room> GetByStatus(System.String _status, int start, int pageLength, out int count)
		{
			return GetByStatus(null, _status, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;Room&gt;"/> class.</returns>
		public abstract TList<Room> GetByStatus(TransactionManager transactionManager, System.String _status, int start, int pageLength, out int count);
						
		/// <summary>
		/// 	Gets rows from the datasource based on the primary key IX_Room_Status_IsDisabled index.
		/// </summary>
		/// <param name="_status"></param>
		/// <param name="_isDisabled"></param>
		/// <returns>Returns an instance of the <see cref="TList&lt;Room&gt;"/> class.</returns>
		public TList<Room> GetByStatusIsDisabled(System.String _status, System.Boolean _isDisabled)
		{
			int count = -1;
			return GetByStatusIsDisabled(null,_status, _isDisabled, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;Room&gt;"/> class.</returns>
		public TList<Room> GetByStatusIsDisabled(System.String _status, System.Boolean _isDisabled, int start, int pageLength)
		{
			int count = -1;
			return GetByStatusIsDisabled(null, _status, _isDisabled, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;Room&gt;"/> class.</returns>
		public TList<Room> GetByStatusIsDisabled(TransactionManager transactionManager, System.String _status, System.Boolean _isDisabled)
		{
			int count = -1;
			return GetByStatusIsDisabled(transactionManager, _status, _isDisabled, 0, int.MaxValue, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;Room&gt;"/> class.</returns>
		public TList<Room> GetByStatusIsDisabled(TransactionManager transactionManager, System.String _status, System.Boolean _isDisabled, int start, int pageLength)
		{
			int count = -1;
			return GetByStatusIsDisabled(transactionManager, _status, _isDisabled, start, pageLength, out count);
		}
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="TList&lt;Room&gt;"/> class.</returns>
		public TList<Room> GetByStatusIsDisabled(System.String _status, System.Boolean _isDisabled, int start, int pageLength, out int count)
		{
			return GetByStatusIsDisabled(null, _status, _isDisabled, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="TList&lt;Room&gt;"/> class.</returns>
		public abstract TList<Room> GetByStatusIsDisabled(TransactionManager transactionManager, System.String _status, System.Boolean _isDisabled, int start, int pageLength, out int count);
		...
		/// <param name="_id"></param>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public ClinicDoctor.Entities.Room GetById(System.Int64 _id)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public ClinicDoctor.Entities.Room GetById(System.Int64 _id, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public ClinicDoctor.Entities.Room GetById(TransactionManager transactionManager, System.Int64 _id)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public ClinicDoctor.Entities.Room GetById(TransactionManager transactionManager, System.Int64 _id, int start, int pageLength)
		{
			int count = -1;
		...
		/// <remarks></remarks>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public ClinicDoctor.Entities.Room GetById(System.Int64 _id, int start, int pageLength, out int count)
		{
			return GetById(null, _id, start, pageLength, out count);
		}
		...
		/// <param name="count">The total number of records.</param>
		/// <returns>Returns an instance of the <see cref="ClinicDoctor.Entities.Room"/> class.</returns>
		public abstract ClinicDoctor.Entities.Room GetById(TransactionManager transactionManager, System.Int64 _id, int start, int pageLength, out int count);
		...
		public static TList<Room> Fill(IDataReader reader, TList<Room> rows, int start, int pageLength)
		{
			...
			for (int i = 0; i < pageLength; i++)
			{
				...
				if (useEntityFactory)
				{
					...
					.Append("|").Append((System.Int64)reader[((int)RoomColumn.Id - 1)]).ToString();
					...
					))
				{
					...
					c.Id = (System.Int64)reader[((int)RoomColumn.Id - 1)];
		...
		public static void RefreshEntity(IDataReader reader, ClinicDoctor.Entities.Room entity)
		{
			...
			entity.Id = (System.Int64)reader[((int)RoomColumn.Id - 1)];

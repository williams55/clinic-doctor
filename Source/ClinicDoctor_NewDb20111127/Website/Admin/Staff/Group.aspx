<%@ Page Language="C#" MasterPageFile="~/Admin/admin.master" AutoEventWireup="true"
    CodeFile="Group.aspx.cs" Inherits="Admin_Group" Title="Group List" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    Group List</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <data:EntityGridView ID="GridView1" runat="server" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged"
        DataSourceID="GroupDataSource" DataKeyNames="Id" AllowMultiColumnSorting="false"
    ...
    <br />
    <asp:Button runat="server" ID="btnGroup" OnClientClick="javascript:location.href='GroupEdit.aspx'; return false;"
        Text="Add New"></asp:Button>
    <data:GroupDataSource ID="GroupDataSource" runat="server" SelectMethod="GetPaged"

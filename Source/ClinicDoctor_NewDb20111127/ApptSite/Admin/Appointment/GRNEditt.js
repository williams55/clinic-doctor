...
scheduler.showLightbox = function(id) {
    ...
    if (ev.isnew == "false") {
        ...
        arrAjax.push($.ajax({
            type: "POST",
            url: "AppointmentIframe.aspx/GetAppointment",
            data: requestdata,
            dataType: "json",
            contentType: "application/json; charset=utf-8",
            success: function(response) {
        ...
        if (ev.section_id) {
            ...
            arrAjax.push($.ajax({
                type: "POST",
                url: "AppointmentIframe.aspx/GetRoom",
                data: requestdata,
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                success: function(response) {
...
function buildURIDoctor() {
    return 'AppointmentIframe.aspx/SearchDoctor?fromDate=' + $("#txtFromDate").val()
...
function buildURIRoom() {
    ...
    return 'AppointmentIframe.aspx/SearchRoom?fromDate=' + $("#txtFromDate").val()
                        + '&toDate=' + $("#txtToDate").val()
                        + '&fromTime=' + $("#cboFromHour").val()
                        + '&toTime=' + $("#cboToHour").val()
...
function GetToken() {
    $("#txtPatient").tokenInput(
        'AppointmentIframe.aspx/SearchPatient',
        {
            theme: "facebook",
...
function LoadRoster(mode, date) {
    ...
    $.ajax({
        type: "POST",
        url: "AppointmentIframe.aspx/GetAppointments",
        data: requestdata,
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: function(response) {

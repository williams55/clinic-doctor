...
<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="Content.aspx.cs" Inherits="Admin_Content" Title="Content List" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Content List</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<br />
		<asp:Button runat="server" ID="btnContent" OnClientClick="javascript:location.href='ContentEdit.aspx'; return false;" Text="Add New"></asp:Button>

...
<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="Group.aspx.cs" Inherits="Admin_Group" Title="Group List" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<br />
		<asp:Button runat="server" ID="btnGroup" OnClientClick="javascript:location.href='GroupEdit.aspx'; return false;" Text="Add New"></asp:Button>

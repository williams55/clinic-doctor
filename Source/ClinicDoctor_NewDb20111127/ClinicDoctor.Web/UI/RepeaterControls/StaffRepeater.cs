...
{
    /// <summary>
    /// A designer class for a strongly typed repeater <c>StaffRepeater</c>
    /// </summary>
	public class StaffRepeaterDesigner : System.Web.UI.Design.ControlDesigner
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:StaffRepeaterDesigner"/> class.
        /// </summary>
		public StaffRepeaterDesigner()
		{
		}
		...
		{
			if (!(component is StaffRepeater))
			{ 
				throw new ArgumentException("Component is not a StaffRepeater."); 
			} 
		...
		public override string GetDesignTimeHtml()
		{
			...
			//
			StaffRepeater z = (StaffRepeater)Component;
			z.DataBind();
    ...
    /// <summary>
    /// A strongly typed repeater control for the <c cref="StaffRepeater"></c> Type.
    /// </summary>
	[Designer(typeof(StaffRepeaterDesigner))]
	[ParseChildren(true)]
	[ToolboxData("<{0}:StaffRepeater runat=\"server\"></{0}:StaffRepeater>")]
	public class StaffRepeater : CompositeDataBoundControl, System.Web.UI.INamingContainer
	{
	    /// <summary>
        /// Initializes a new instance of the <see cref="T:StaffRepeater"/> class.
        /// </summary>
		public StaffRepeater()
		{
		}
		...
		[Browsable(false)]
		[TemplateContainer(typeof(StaffItem))]
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						ClinicDoctor.Entities.Staff entity = o as ClinicDoctor.Entities.Staff;
						StaffItem container = new StaffItem(entity);
	...
	public class StaffItem : System.Web.UI.Control, System.Web.UI.INamingContainer
	{
		private ClinicDoctor.Entities.Staff _entity;
        ...
        /// <summary>
        /// Gets a <see cref="T:ClinicDoctor.Entities.Staff"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public ClinicDoctor.Entities.Staff Entity
        {
            get { return _entity; }
        }
	}

...
<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="Services.aspx.cs" Inherits="Admin_Services" Title="Services List" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Services List</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridView1" runat="server"			
				...
				ExcelExportFileName="Export_Services.xls"  		
			>
			<Columns>
				<asp:CommandField ShowSelectButton="True" ShowEditButton="True" />				
				<asp:BoundField DataField="PriorityIndex" HeaderText="Priority Index" SortExpression="[PriorityIndex]"  />
				<asp:BoundField DataField="ShortTitle" HeaderText="Short Title" SortExpression="[ShortTitle]"  />
		...
		<br />
		<asp:Button runat="server" ID="btnServices" OnClientClick="javascript:location.href='ServicesEdit.aspx'; return false;" Text="Add New"></asp:Button>

...
namespace AppointmentSystem.Web.UI
{
    ...
    /// <summary>
    /// A strongly typed repeater control for the <see cref="RoomRepeater"/> Type.
    /// </summary>
...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						AppointmentSystem.Entities.Room entity = o as AppointmentSystem.Entities.Room;
	...
	{
		private AppointmentSystem.Entities.Room _entity;
        ...
        /// Initializes a new instance of the <see cref="T:RoomItem"/> class.
        /// </summary>
		public RoomItem(AppointmentSystem.Entities.Room entity)
			: base()
		{
			_entity = entity;
		}
        ...
        /// <summary>
        /// Gets a <see cref="T:AppointmentSystem.Entities.Room"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public AppointmentSystem.Entities.Room Entity
        {
            get { return _entity; }
        }
	}

...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentContent" runat="Server">
    ...
    <div id="box-other">
        <dx:ASPxGridView ID="grid" ClientInstanceName="grid" runat="server" DataSourceID="AccessDataSource1"
            ...
            OnRowUpdating="grid_RowUpdating" onrowvalidating="grid_RowValidating">
            <Columns>
                <dx:GridViewDataColumn FieldName="Id" VisibleIndex="1" />
                <dx:GridViewDataColumn FieldName="Title" VisibleIndex="2" />
                <dx:GridViewDataColumn FieldName="ColorCode" VisibleIndex="3" />
                <dx:GridViewDataColumn FieldName="PriorityIndex" VisibleIndex="4" />
            ...
            <Templates>
                <EditForm>
                    <div id="devexpress-form" style=" height:170px;">
                            ...
                            <table class="edit-form">
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="content-row" style=" line-height:30px;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="content-row" colspan="1">
                                            <dx:ASPxTextBox runat="server" ID="txtNote" Text='<%# Bind("PriorityIndex")%>' CssClass="text-form">
                                            </dx:ASPxTextBox>
                                        </td>
                                    </tr>
                                </tbody>
                    ...
                    <div style="text-align: right; padding: 2px 0px 2px 2px">

...
namespace AppointmentSystem.Entities
{
	...
	{		
		...
		/// <summary>
		///	Holds a collection of Sms objects
		///	which are related to this object through the relation FK_Sms_Appointment
		/// </summary>	
		[System.ComponentModel.Bindable(System.ComponentModel.BindableSupport.Yes)]
		public virtual TList<Sms> SmsCollection
		{
			get { return entityData.SmsCollection; }
			set { entityData.SmsCollection = value; }	
		}
		...
		protected virtual Appointment Copy(IDictionary existingCopies)
		{
			...
			copy.SmsCollection = (TList<Sms>) MakeCopyOf(this.SmsCollection, existingCopies); 
...
/*
	...
	internal protected class AppointmentEntityData : ICloneable, ICloneableEx
	{
		...
		private TList<Sms> _smsAppointmentId;
		...
		public TList<Sms> SmsCollection
		{
			get
			{
				if (_smsAppointmentId == null)
				{
				_smsAppointmentId = new TList<Sms>();
				}
	
				return _smsAppointmentId;
			}
			set { _smsAppointmentId = value; }
		}
		...
		public Object Clone()
		{
			...
			if (this._smsAppointmentId != null)
				_tmp.SmsCollection = (TList<Sms>) MakeCopyOf(this.SmsCollection); 
		...
		public object Clone(IDictionary existingCopies)
		{
			...
			_tmp.SmsCollection = (TList<Sms>) MakeCopyOf(this.SmsCollection, existingCopies); 
			#endregion Child Collections

...
namespace AppointmentSystem.Entities
{
	...
	{		
			...
			System.String _createUser, System.DateTime _createDate, System.String _updateUser, System.DateTime _updateDate)
		{
			...
			newUserRole.CreateDate = _createDate;
			newUserRole.UpdateUser = _updateUser;
			newUserRole.UpdateDate = _updateDate;
			return newUserRole;
		}
		...
		public virtual System.Int64 Id
		{
			...
			set
			{
				...
				OnColumnChanged(UserRoleColumn.Id, this.entityData.Id);
		...
		public virtual System.Boolean IsDisabled
		{
			...
			set
			{
				...
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UserRoleColumn.IsDisabled, this.entityData.IsDisabled);
		...
		public override System.String CreateUser
		{
			...
			set
			{
				...
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UserRoleColumn.CreateUser, this.entityData.CreateUser);
		...
		public override System.DateTime CreateDate
		{
			...
			set
			{
				...
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UserRoleColumn.CreateDate, this.entityData.CreateDate);
		...
		public override System.String UpdateUser
		{
			...
			set
			{
				...
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UserRoleColumn.UpdateUser, this.entityData.UpdateUser);
		...
		public override System.DateTime UpdateDate
		{
			...
			set
			{
				...
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(UserRoleColumn.UpdateDate, this.entityData.UpdateDate);
...
/*
	...
	public class UserRoleKey : EntityKeyBase
	{
		...
		/// Initializes a new instance of the UserRoleKey class.
		/// </summary>
		public UserRoleKey(System.Int64 _id)
		{
			#region Init Properties

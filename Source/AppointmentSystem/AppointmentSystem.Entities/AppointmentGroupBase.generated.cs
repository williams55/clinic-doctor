...
/*
	...
	Important: Do not modify this file. Edit the file AppointmentGroup.cs instead.
*/
...
namespace AppointmentSystem.Entities
{
	...
	public abstract partial class AppointmentGroupBase : EntityBase, IAppointmentGroup, IEntityId<AppointmentGroupKey>, System.IComparable, System.ICloneable, ICloneableEx, IEditableObject, IComponent, INotifyPropertyChanged
	{		
		...
		/// </summary>
		private AppointmentGroupEntityData entityData;
		
		/// <summary>
		/// 	Hold the original data of the entity, as loaded from the repository.
		/// </summary>
		private AppointmentGroupEntityData _originalData;
		
		/// <summary>
		/// 	Hold a backup of the inner data of the entity.
		/// </summary>
		private AppointmentGroupEntityData backupData; 
		...
		[NonSerialized]
		private TList<AppointmentGroup> parentCollection;
		...
		/// </summary>
		[field:NonSerialized]
		public event AppointmentGroupEventHandler ColumnChanging;		
		
		/// <summary>
		/// Occurs after a value has been changed for the specified column.
		/// </summary>
		[field:NonSerialized]
		public event AppointmentGroupEventHandler ColumnChanged;
			...
			System.String _updateUser, System.DateTime _updateDate, System.Int32? _unitId)
		{
			...
			newAppointmentGroup.UpdateUser = _updateUser;
			newAppointmentGroup.UpdateDate = _updateDate;
			newAppointmentGroup.UnitId = _unitId;
			return newAppointmentGroup;
		}
		...
		public virtual System.Int32 Id
		{
			...
			set
			{
				...
				OnColumnChanging(AppointmentGroupColumn.Id, this.entityData.Id);
		...
		public virtual System.String Title
		{
			...
			set
			{
				...
				OnColumnChanging(AppointmentGroupColumn.Title, this.entityData.Title);
				this.entityData.Title = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(AppointmentGroupColumn.Title, this.entityData.Title);
		...
		public virtual System.String Note
		{
			...
			set
			{
				...
				OnColumnChanging(AppointmentGroupColumn.Note, this.entityData.Note);
		...
		public virtual System.Boolean IsDisabled
		{
			...
			set
			{
				...
				OnColumnChanging(AppointmentGroupColumn.IsDisabled, this.entityData.IsDisabled);
				this.entityData.IsDisabled = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(AppointmentGroupColumn.IsDisabled, this.entityData.IsDisabled);
		...
		public virtual System.String CreateUser
		{
			...
			set
			{
				...
				OnColumnChanging(AppointmentGroupColumn.CreateUser, this.entityData.CreateUser);
				this.entityData.CreateUser = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(AppointmentGroupColumn.CreateUser, this.entityData.CreateUser);
		...
		public virtual System.DateTime CreateDate
		{
			...
			set
			{
				...
				OnColumnChanging(AppointmentGroupColumn.CreateDate, this.entityData.CreateDate);
				this.entityData.CreateDate = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(AppointmentGroupColumn.CreateDate, this.entityData.CreateDate);
		...
		public virtual System.String UpdateUser
		{
			...
			set
			{
				...
				OnColumnChanging(AppointmentGroupColumn.UpdateUser, this.entityData.UpdateUser);
				this.entityData.UpdateUser = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(AppointmentGroupColumn.UpdateUser, this.entityData.UpdateUser);
		...
		public virtual System.DateTime UpdateDate
		{
			...
			set
			{
				...
				OnColumnChanging(AppointmentGroupColumn.UpdateDate, this.entityData.UpdateDate);
				this.entityData.UpdateDate = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(AppointmentGroupColumn.UpdateDate, this.entityData.UpdateDate);
		...
		///		Define current unit belongs to what tab.
		/// 		/// It's seperated by semi-comma [;]
		...
		public virtual System.Int32? UnitId
		{
			...
			set
			{
				...
				OnColumnChanging(AppointmentGroupColumn.UnitId, this.entityData.UnitId);
				this.entityData.UnitId = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(AppointmentGroupColumn.UnitId, this.entityData.UnitId);
		...
		///	which are related to this object through the relation FK_Appointment_AppointmentGroup
		/// </summary>	
		...
		void IEditableObject.BeginEdit() 
	    {
	        ...
	        if (!inTxn) 
	        {
	            this.backupData = this.entityData.Clone() as AppointmentGroupEntityData;
	            inTxn = true;
	        ...
	        if (this.inTxn) 
	        {
	        	...
	        	//if (this.EntityState == EntityState.Added)
	        	{
					if (this.parentCollection != null)
						this.parentCollection.Remove( (AppointmentGroup) this ) ;
				}	            
	        }
	    ...
	    public override object ParentCollection
	    {
	        ...
	        set 
	        {
	            this.parentCollection = value as TList<AppointmentGroup>;
	        }
	    }
	    ...
	    private void OnEntityChanged() 
	    {
	        ...
	        {
	            this.parentCollection.EntityChanged(this as AppointmentGroup);
	        }
	    }
		...
		///<summary>
		///  Returns a Typed AppointmentGroup Entity 
		///</summary>
		protected virtual AppointmentGroup Copy(IDictionary existingCopies)
		{
			...
			//shallow copy entity
			AppointmentGroup copy = new AppointmentGroup();
		...
		///  Returns a Typed AppointmentGroup Entity 
		///</summary>
		public virtual AppointmentGroup Copy()
		{
		...
		///<summary>
		///  Returns a Typed AppointmentGroup Entity which is a deep copy of the current entity.
		///</summary>
		public virtual AppointmentGroup DeepCopy()
		{
			return EntityHelper.Clone<AppointmentGroup>(this as AppointmentGroup);	
		}
		#endregion
		...
		public override void CancelChanges()
		{
			...
			{
				this.entityData = this._originalData.Clone() as AppointmentGroupEntityData;
			}
			else
			{
		...
		public override void AcceptChanges()
		{
			...
			this._originalData = this.entityData.Clone() as AppointmentGroupEntityData;
		}
		...
		/// </returns>
		public bool IsPropertyChanged(AppointmentGroupColumn column)
		{
			switch(column)
			{
					case AppointmentGroupColumn.Id:
					return entityData.Id != _originalData.Id;
					case AppointmentGroupColumn.Title:
					...
					case AppointmentGroupColumn.CreateDate:
					return entityData.CreateDate != _originalData.CreateDate;
					case AppointmentGroupColumn.UpdateUser:
					return entityData.UpdateUser != _originalData.UpdateUser;
					case AppointmentGroupColumn.UpdateDate:
		...
		{
			return 	IsPropertyChanged(EntityHelper.GetEnumValue< AppointmentGroupColumn >(columnName));
		}
		...
		///<summary>
		///  Returns a AppointmentGroup Entity with the original data.
		///</summary>
		public AppointmentGroup GetOriginalEntity()
		{
			...
			return (AppointmentGroup)this.Clone();
		}
		#endregion
	...
	#region Value Semantics Instance Equality
        ...
        ///<returns>true if Object1 is a <see cref="AppointmentGroupBase"/> and has the same value as this instance; otherwise, false.</returns>
        public override bool Equals(object Object1)
        {
			// Cast exception if Object1 is null or DbNull
			if (Object1 != null && Object1 != DBNull.Value && Object1 is AppointmentGroupBase)
				return ValueEquals(this, (AppointmentGroupBase)Object1);
			else
				return false;
        }
        ...
        /// Provides a hash function that is appropriate for <see cref="AppointmentGroupBase"/> class 
		...
		///<returns>true if toObject is a <see cref="AppointmentGroupBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(AppointmentGroupBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="AppointmentGroupBase"/> instances are considered equal using value semantics.
		///</summary>
		///<param name="Object1">The first <see cref="AppointmentGroupBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="AppointmentGroupBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool ValueEquals(AppointmentGroupBase Object1, AppointmentGroupBase Object2)
		{
			// both are null
		...
		public virtual int CompareTo(object obj)
		{
			...
			//return this. GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]) .CompareTo(((AppointmentGroupBase)obj).GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]));
		}
		
		/*
		// static method to get a Comparer object
        public static AppointmentGroupComparer GetComparer()
        {
            return new AppointmentGroupComparer();
        }
        */

        // Comparer delegates back to AppointmentGroup
...
/*
        ...
        public int CompareTo(AppointmentGroup rhs, AppointmentGroupColumn which)
        {
            switch (which)
            {
        ...
        */
		...
		#region IEntityKey<AppointmentGroupKey> Members
		
		// member variable for the EntityId property
		private AppointmentGroupKey _entityId;

		/// <summary>
		/// Gets or sets the EntityId property.
		/// </summary>
		[XmlIgnore]
		public virtual AppointmentGroupKey EntityId
		{
			get
			{
				if ( _entityId == null )
				{
					_entityId = new AppointmentGroupKey(this);
				}
		...
		public override string EntityTrackingKey
		{
			get
			{
				if(entityTrackingKey == null)
					entityTrackingKey = new System.Text.StringBuilder("AppointmentGroup")
	...
	/// <summary>
	///		The data structure representation of the 'AppointmentGroup' table.
	/// </summary>
	/// <remarks>
	...
	[Serializable]
	internal protected class AppointmentGroupEntityData : ICloneable, ICloneableEx
	{
		#region Variable Declarations
		...
		private TList<Appointment> _appointmentAppointmentGroupId;
		
		/// <summary>
		///	Holds a collection of entity objects
		///	which are related to this object through the relation _appointmentAppointmentGroupId
		/// </summary>
		...
		public TList<Appointment> AppointmentCollection
		{
			get
			{
				if (_appointmentAppointmentGroupId == null)
				{
				_appointmentAppointmentGroupId = new TList<Appointment>();
				}
	
				return _appointmentAppointmentGroupId;
			}
			set { _appointmentAppointmentGroupId = value; }
		}
		...
		public Object Clone()
		{
			...
			//deep copy nested objects
			if (this._appointmentAppointmentGroupId != null)
		...
		/// </summary>
		/// <param name="column">The <see cref="AppointmentGroupColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanging(AppointmentGroupColumn column)
		{
		...
		/// </summary>
		/// <param name="column">The <see cref="AppointmentGroupColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanged(AppointmentGroupColumn column)
		{
		...
		public virtual void OnColumnChanging(AppointmentGroupColumn column, object value)
		{
			...
			if (!SuppressEntityEvents)
			{
				AppointmentGroupEventHandler handler = ColumnChanging;
				if(handler != null)
				{
					handler(this, new AppointmentGroupEventArgs(column, value));
				}
			}
		}
		...
		/// <param name="column">The <see cref="AppointmentGroupColumn"/> which has raised the event.</param>
		/// <param name="value">The changed value.</param>
		public virtual void OnColumnChanged(AppointmentGroupColumn column, object value)
		{
			if (!SuppressEntityEvents)
			{
				AppointmentGroupEventHandler handler = ColumnChanged;
				if(handler != null)
				{
					handler(this, new AppointmentGroupEventArgs(column, value));
				}
	...
	#region AppointmentGroupEventArgs class
	/// <summary>
	/// Provides data for the ColumnChanging and ColumnChanged events.
	/// </summary>
	/// <remarks>
	/// The ColumnChanging and ColumnChanged events occur when a change is made to the value 
	/// of a property of a <see cref="AppointmentGroup"/> object.
	/// </remarks>
	public class AppointmentGroupEventArgs : System.EventArgs
	{
		private AppointmentGroupColumn column;
		private object value;
		
		///<summary>
		/// Initalizes a new Instance of the AppointmentGroupEventArgs class.
		///</summary>
		public AppointmentGroupEventArgs(AppointmentGroupColumn column)
		{
			this.column = column;
		}
		...
		/// Initalizes a new Instance of the AppointmentGroupEventArgs class.
		///</summary>
		public AppointmentGroupEventArgs(AppointmentGroupColumn column, object value)
		{
			this.column = column;
			this.value = value;
		}
		...
		///<summary>
		/// The AppointmentGroupColumn that was modified, which has raised the event.
		///</summary>
		///<value cref="AppointmentGroupColumn" />
		public AppointmentGroupColumn Column { get { return this.column; } }
	...
	///<summary>
	/// Define a delegate for all AppointmentGroup related events.
	///</summary>
	public delegate void AppointmentGroupEventHandler(object sender, AppointmentGroupEventArgs e);
	
	#region AppointmentGroupComparer
		
	/// <summary>
	///	Strongly Typed IComparer
	/// </summary>
	public class AppointmentGroupComparer : System.Collections.Generic.IComparer<AppointmentGroup>
	{
		AppointmentGroupColumn whichComparison;
		
		/// <summary>
        /// Initializes a new instance of the <see cref="T:AppointmentGroupComparer"/> class.
        /// </summary>
		public AppointmentGroupComparer()
        {            
        }               
        ...
        public AppointmentGroupComparer(AppointmentGroupColumn column)
        {
            this.whichComparison = column;
        }

		/// <summary>
        /// Determines whether the specified <see cref="AppointmentGroup"/> instances are considered equal.
        /// </summary>
        /// <param name="a">The first <see cref="AppointmentGroup"/> to compare.</param>
        /// <param name="b">The second <c>AppointmentGroup</c> to compare.</param>
        /// <returns>true if objA is the same instance as objB or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
        public bool Equals(AppointmentGroup a, AppointmentGroup b)
        {
        ...
        /// <returns></returns>
        public int GetHashCode(AppointmentGroup entity)
        {
        ...
        /// <returns></returns>
        public int Compare(AppointmentGroup a, AppointmentGroup b)
        {
        ...
        public AppointmentGroupColumn WhichComparison
        {
	...
	#region AppointmentGroupKey Class

	/// <summary>
	/// Wraps the unique identifier values for the <see cref="AppointmentGroup"/> object.
	/// </summary>
	[Serializable]
	[CLSCompliant(true)]
	public class AppointmentGroupKey : EntityKeyBase
	{
		#region Constructors
		...
		/// Initializes a new instance of the AppointmentGroupKey class.
		/// </summary>
		public AppointmentGroupKey(AppointmentGroupBase entity)
		{
			this.Entity = entity;
		...
		private AppointmentGroupBase _entity;
		
		/// <summary>
		/// Gets or sets the Entity property.
		/// </summary>
		public AppointmentGroupBase Entity
		{
			get { return _entity; }
			set { _entity = value; }
		}
	...
	#region AppointmentGroupColumn Enum
	
	/// <summary>
	/// Enumerate the AppointmentGroup columns.
	/// </summary>
	[Serializable]
	public enum AppointmentGroupColumn : int
	{
		/// <summary>
		/// Id : 
		/// </summary>

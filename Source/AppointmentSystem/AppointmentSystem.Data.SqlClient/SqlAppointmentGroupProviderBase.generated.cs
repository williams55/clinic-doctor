...
/*
	...
	Important: Do not modify this file. Edit the file SqlAppointmentGroupProvider.cs instead.
*/
...
namespace AppointmentSystem.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlAppointmentGroupProviderBase : AppointmentGroupProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlAppointmentGroupProviderBase"/> instance.
		/// </summary>
		public SqlAppointmentGroupProviderBase()
		{
		}
	...
	public SqlAppointmentGroupProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.String _id)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.AppointmentGroup_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(AppointmentGroup)
					,_id);
		...
		public override TList<AppointmentGroup> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<AppointmentGroup>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.AppointmentGroup_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@UnitId", DbType.String, DBNull.Value);
			...
			//Create Collection
			TList<AppointmentGroup> rows = new TList<AppointmentGroup>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of AppointmentSystem.Entities.AppointmentGroup objects.</returns>
		public override TList<AppointmentGroup> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.AppointmentGroup_Find_Dynamic", typeof(AppointmentGroupColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<AppointmentGroup> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.AppointmentGroup_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of AppointmentSystem.Entities.AppointmentGroup objects.</returns>
		public override TList<AppointmentGroup> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.AppointmentGroup_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<AppointmentGroup> GetByUnitId(TransactionManager transactionManager, System.String _unitId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.AppointmentGroup_GetByUnitId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@UnitId", DbType.String, _unitId);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override AppointmentSystem.Entities.AppointmentGroup GetById(TransactionManager transactionManager, System.String _id, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.AppointmentGroup_GetById", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@Id", DbType.String, _id);
			
			IDataReader reader = null;
			TList<AppointmentGroup> tmp = new TList<AppointmentGroup>();
			try
			{
				//Provider Data Requesting Command Event
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<AppointmentSystem.Entities.AppointmentGroup> entities)
		{
			...
			bulkCopy.DestinationTableName = "AppointmentGroup";
			...
			DataColumn col8 = dataTable.Columns.Add("UnitId", typeof(System.String));
			...
			foreach(AppointmentSystem.Entities.AppointmentGroup entity in entities)
			{
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, AppointmentSystem.Entities.AppointmentGroup entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.AppointmentGroup_Insert", _useStoredProcedure);
			...
			database.AddInParameter(commandWrapper, "@UnitId", DbType.String, entity.UnitId );
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, AppointmentSystem.Entities.AppointmentGroup entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.AppointmentGroup_Update", _useStoredProcedure);

/*
	...
	Important: Do not modify this file. Edit the file SqlSmsLogProvider.cs instead.
*/
...
namespace AppointmentSystem.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlSmsLogProviderBase : SmsLogProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlSmsLogProviderBase"/> instance.
		/// </summary>
		public SqlSmsLogProviderBase()
		{
		}
	...
	public SqlSmsLogProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.Guid _id)
		{
			...
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.SmsLog_Delete", _useStoredProcedure);
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(SmsLog)
					,_id);
		...
		public override TList<SmsLog> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<SmsLog>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.SmsLog_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@SmsId", DbType.Int64, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@RealSendTime", DbType.DateTime, DBNull.Value);
		...
		database.AddInParameter(commandWrapper, "@UpdateDate", DbType.DateTime, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				if (clause.Trim().StartsWith("smsid ") || clause.Trim().StartsWith("smsid="))
				{
					database.SetParameterValue(commandWrapper, "@SmsId", 
				...
				if (clause.Trim().StartsWith("realsendtime ") || clause.Trim().StartsWith("realsendtime="))
				{
					database.SetParameterValue(commandWrapper, "@RealSendTime", 
			...
			//Create Collection
			TList<SmsLog> rows = new TList<SmsLog>();
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of AppointmentSystem.Entities.SmsLog objects.</returns>
		public override TList<SmsLog> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.SmsLog_Find_Dynamic", typeof(SmsLogColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<SmsLog> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.SmsLog_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of AppointmentSystem.Entities.SmsLog objects.</returns>
		public override TList<SmsLog> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.SmsLog_GetPaged", _useStoredProcedure);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<SmsLog> GetBySmsId(TransactionManager transactionManager, System.Int64 _smsId, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.SmsLog_GetBySmsId", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@SmsId", DbType.Int64, _smsId);
			...
			{
				//Provider Data Requesting Command Event
				OnDataRequesting(new CommandEventArgs(commandWrapper, "GetBySmsId", rows)); 
				...
				//Provider Data Requested Command Event
				OnDataRequested(new CommandEventArgs(commandWrapper, "GetBySmsId", rows)); 
			}
			finally
			{
				if (reader != null) 
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override AppointmentSystem.Entities.SmsLog GetById(TransactionManager transactionManager, System.Guid _id, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.SmsLog_GetById", _useStoredProcedure);
			
				database.AddInParameter(commandWrapper, "@Id", DbType.Guid, _id);
			
			IDataReader reader = null;
			TList<SmsLog> tmp = new TList<SmsLog>();
			try
			{
				//Provider Data Requesting Command Event
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<AppointmentSystem.Entities.SmsLog> entities)
		{
			...
			bulkCopy.DestinationTableName = "SmsLog";
			
			DataTable dataTable = new DataTable();
			DataColumn col0 = dataTable.Columns.Add("Id", typeof(System.Guid));
			col0.AllowDBNull = false;		
			DataColumn col1 = dataTable.Columns.Add("SmsId", typeof(System.Int64));
			col1.AllowDBNull = false;		
			DataColumn col2 = dataTable.Columns.Add("Message", typeof(System.String));
			col2.AllowDBNull = true;		
			DataColumn col3 = dataTable.Columns.Add("Mobile", typeof(System.String));
			col3.AllowDBNull = false;		
			DataColumn col4 = dataTable.Columns.Add("Title", typeof(System.String));
			col4.AllowDBNull = true;		
			DataColumn col5 = dataTable.Columns.Add("SendTime", typeof(System.DateTime));
			col5.AllowDBNull = false;		
			DataColumn col6 = dataTable.Columns.Add("RealSendTime", typeof(System.DateTime));
			col6.AllowDBNull = true;		
			DataColumn col7 = dataTable.Columns.Add("IsSent", typeof(System.Boolean));
			...
			bulkCopy.ColumnMappings.Add("RealSendTime", "RealSendTime");
			...
			foreach(AppointmentSystem.Entities.SmsLog entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["RealSendTime"] = entity.RealSendTime.HasValue ? (object) entity.RealSendTime  : System.DBNull.Value;
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">AppointmentSystem.Entities.SmsLog object to update.</param>
		/// <remarks>
		///		After updating the datasource, the AppointmentSystem.Entities.SmsLog object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, AppointmentSystem.Entities.SmsLog entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.SmsLog_Update", _useStoredProcedure);

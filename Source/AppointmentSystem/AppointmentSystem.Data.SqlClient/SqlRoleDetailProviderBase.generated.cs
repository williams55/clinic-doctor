...
/*
	...
	Important: Do not modify this file. Edit the file SqlRoleDetailProvider.cs instead.
*/
...
namespace AppointmentSystem.Data.SqlClient
{
	...
	///</summary>
	public abstract partial class SqlRoleDetailProviderBase : RoleDetailProviderBase
	{
		#region Declarations
		...
		/// <summary>
		/// Creates a new <see cref="SqlRoleDetailProviderBase"/> instance.
		/// </summary>
		public SqlRoleDetailProviderBase()
		{
		}
	...
	public SqlRoleDetailProviderBase(string connectionString, bool useStoredProcedure, string providerInvariantName)
	{
    ...
    public string ProviderInvariantName
    {
		...
		public override bool Delete(TransactionManager transactionManager, System.String _id)
		{
			...
			{
				string entityKey = EntityLocator.ConstructKeyFromPkItems(typeof(RoleDetail)
					,_id);
		...
		public override TList<RoleDetail> Find(TransactionManager transactionManager, string whereClause, int start, int pageLength, out int count)
		{
			count = -1;
			if (whereClause.IndexOf(";") > -1)
				return new TList<RoleDetail>();
	
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.RoleDetail_Find", _useStoredProcedure);
		...
		database.AddInParameter(commandWrapper, "@UpdateDate", DbType.DateTime, DBNull.Value);
	   		...
	   		foreach (string clause in clauses)
			{
				...
				{
					database.SetParameterValue(commandWrapper, "@Crud", 
		...
		/// <param name="count">out. The number of rows that match this query.</param>
		/// <returns>Returns a typed collection of AppointmentSystem.Entities.RoleDetail objects.</returns>
		public override TList<RoleDetail> Find(TransactionManager transactionManager, IFilterParameterCollection parameters, string orderBy, int start, int pageLength, out int count)
		{
			...
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.RoleDetail_Find_Dynamic", typeof(RoleDetailColumn), filter, orderBy, start, pageLength);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override TList<RoleDetail> GetAll(TransactionManager transactionManager, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.RoleDetail_Get_List", _useStoredProcedure);
		...
		/// <remarks></remarks>
		/// <returns>Returns a typed collection of AppointmentSystem.Entities.RoleDetail objects.</returns>
		public override TList<RoleDetail> GetPaged(TransactionManager transactionManager, string whereClause, string orderBy, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			DbCommand commandWrapper = StoredProcedureProvider.GetCommandWrapper(database, "dbo.RoleDetail_GetPaged", _useStoredProcedure);
		...
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<AppointmentSystem.Entities.RoleDetail> entities)
		{
			...
			foreach(AppointmentSystem.Entities.RoleDetail entity in entities)
			{
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, AppointmentSystem.Entities.RoleDetail entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, AppointmentSystem.Entities.RoleDetail entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);

...
namespace ClinicDoctor.Data.SqlClient
{
    ...
    public string ProviderInvariantName
    {
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override ClinicDoctor.Entities.Roster GetById(TransactionManager transactionManager, System.Int32 _id, int start, int pageLength, out int count)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
		...
		/// <remarks>
		///		After inserting into the datasource, the ClinicDoctor.Entities.Roster object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
		public override void BulkInsert(TransactionManager transactionManager, TList<ClinicDoctor.Entities.Roster> entities)
		{
			...
			DataColumn col1 = dataTable.Columns.Add("RosterTypeId", typeof(System.Int32));
			...
			foreach(ClinicDoctor.Entities.Roster entity in entities)
			{
				...
				DataRow row = dataTable.NewRow();
					...
					row["RosterTypeId"] = entity.RosterTypeId.HasValue ? (object) entity.RosterTypeId  : System.DBNull.Value;
		...
		/// <summary>
		/// 	Inserts a ClinicDoctor.Entities.Roster object into the datasource using a transaction.
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">ClinicDoctor.Entities.Roster object to insert.</param>
		/// <remarks>
		///		After inserting into the datasource, the ClinicDoctor.Entities.Roster object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>	
        ...
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Insert(TransactionManager transactionManager, ClinicDoctor.Entities.Roster entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);
			...
			database.AddInParameter(commandWrapper, "@RosterTypeId", DbType.Int32, (entity.RosterTypeId.HasValue ? (object) entity.RosterTypeId  : System.DBNull.Value));
		...
		/// </summary>
		/// <param name="transactionManager"><see cref="TransactionManager"/> object</param>
		/// <param name="entity">ClinicDoctor.Entities.Roster object to update.</param>
		/// <remarks>
		///		After updating the datasource, the ClinicDoctor.Entities.Roster object will be updated
		/// 	to refelect any changes made by the datasource. (ie: identity or computed columns)
		/// </remarks>
		/// <returns>Returns true if operation is successful.</returns>
        /// <exception cref="System.Exception">The command could not be executed.</exception>
        /// <exception cref="System.Data.DataException">The <paramref name="transactionManager"/> is not open.</exception>
        /// <exception cref="System.Data.Common.DbException">The command could not be executed.</exception>
		public override bool Update(TransactionManager transactionManager, ClinicDoctor.Entities.Roster entity)
		{
			SqlDatabase database = new SqlDatabase(this._connectionString);

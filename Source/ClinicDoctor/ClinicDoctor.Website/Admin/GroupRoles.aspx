...
<%@ Page Language="C#" Theme="Default" MasterPageFile="~/MasterPages/admin.master" AutoEventWireup="true"  CodeFile="GroupRoles.aspx.cs" Inherits="Admin_GroupRoles" Title="GroupRoles List" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">Group Roles List</asp:Content>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
		...
		<data:EntityGridView ID="GridView1" runat="server"			
				...
				DataSourceID="GroupRolesDataSource"
				DataKeyNames="Id"
			...
			<EmptyDataTemplate>
				<b>No GroupRoles Found!</b>
			</EmptyDataTemplate>
		</data:EntityGridView>
		<br />
		<asp:Button runat="server" ID="btnGroupRoles" OnClientClick="javascript:location.href='GroupRolesEdit.aspx'; return false;" Text="Add New"></asp:Button>

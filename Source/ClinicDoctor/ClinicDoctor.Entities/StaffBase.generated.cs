...
namespace ClinicDoctor.Entities
{
	...
	{		
		...
		public StaffBase(System.String _firstName, System.String _lastName, System.String _shortName, 
			System.Int32 _groupId, System.String _userName, System.String _address, System.String _homePhone, System.String _workPhone, 
		...
		/// to check the value of IsIsFemaleNull() and perform business logic appropriately.
		/// </remarks>
		...
		/// <summary>
		///	Holds a collection of NurseAppointment objects
		///	which are related to this object through the relation FK_NurseAppointment_Staff
		/// </summary>	
		[System.ComponentModel.Bindable(System.ComponentModel.BindableSupport.Yes)]
		public virtual TList<NurseAppointment> NurseAppointmentCollection
		{
			get { return entityData.NurseAppointmentCollection; }
			set { entityData.NurseAppointmentCollection = value; }	
		}
		...
		/// <summary>
		///	Holds a collection of StaffRoles objects
		///	which are related to this object through the relation FK_StaffRoles_Staff
		/// </summary>	
		[System.ComponentModel.Bindable(System.ComponentModel.BindableSupport.Yes)]
		public virtual TList<StaffRoles> StaffRolesCollection
		{
			get { return entityData.StaffRolesCollection; }
			set { entityData.StaffRolesCollection = value; }	
		}
		...
		public override string[] TableColumns
		{
			get
			{
				return new string[] {"Id", "FirstName", "LastName", "ShortName", "GroupId", "UserName", "Address", "HomePhone", "WorkPhone", "CellPhone", "Birthdate", "IsFemale", "Title", "Note", "IsDisabled", "CreateUser", "CreateDate", "UpdateUser", "UpdateDate"};
			}
		}
		#endregion 
		...
		protected virtual Staff Copy(IDictionary existingCopies)
		{
			...
			copy.NurseAppointmentCollection = (TList<NurseAppointment>) MakeCopyOf(this.NurseAppointmentCollection, existingCopies); 
			...
			copy.StaffRolesCollection = (TList<StaffRoles>) MakeCopyOf(this.StaffRolesCollection, existingCopies); 
	...
	#region Value Semantics Instance Equality
        ...
        public override int GetHashCode()
        {
			return this.Id.GetHashCode() ^ 
					...
					((this.IsFemale == null) ? string.Empty : this.IsFemale.ToString()).GetHashCode() ^ 
		...
		public static bool ValueEquals(StaffBase Object1, StaffBase Object2)
		{
			...
			if ( Object1.IsFemale != null && Object2.IsFemale != null )
			{
				if (Object1.IsFemale != Object2.IsFemale)
					equal = false;
			}
			else if (Object1.IsFemale == null ^ Object2.IsFemale == null )
			{
				equal = false;
			}
...
/*
        ...
        public int CompareTo(Staff rhs, StaffColumn which)
        {
            switch (which)
            {
            	...
            	case StaffColumn.IsFemale:
            		return this.IsFemale.Value.CompareTo(rhs.IsFemale.Value);
        ...
        */
		...
		public override string ToString()
		{
			return string.Format(System.Globalization.CultureInfo.InvariantCulture,
				"{20}{19}- Id: {0}{19}- FirstName: {1}{19}- LastName: {2}{19}- ShortName: {3}{19}- GroupId: {4}{19}- UserName: {5}{19}- Address: {6}{19}- HomePhone: {7}{19}- WorkPhone: {8}{19}- CellPhone: {9}{19}- Birthdate: {10}{19}- IsFemale: {11}{19}- Title: {12}{19}- Note: {13}{19}- IsDisabled: {14}{19}- CreateUser: {15}{19}- CreateDate: {16}{19}- UpdateUser: {17}{19}- UpdateDate: {18}{19}{21}", 
				this.Id,
				...
				(this.IsFemale == null) ? string.Empty : this.IsFemale.ToString(),
	...
	internal protected class StaffEntityData : ICloneable, ICloneableEx
	{
		...
		/// IsFemale : 
		/// </summary>
		public System.Boolean?		  IsFemale = null;
		...
		private TList<NurseAppointment> _nurseAppointmentNurseId;
		
		/// <summary>
		///	Holds a collection of entity objects
		///	which are related to this object through the relation _nurseAppointmentNurseId
		/// </summary>
		
		public TList<NurseAppointment> NurseAppointmentCollection
		{
			get
			{
				if (_nurseAppointmentNurseId == null)
				{
				_nurseAppointmentNurseId = new TList<NurseAppointment>();
				}
	
				return _nurseAppointmentNurseId;
			}
			set { _nurseAppointmentNurseId = value; }
		}
		...
		private TList<StaffRoles> _staffRolesStaffId;
		
		/// <summary>
		///	Holds a collection of entity objects
		///	which are related to this object through the relation _staffRolesStaffId
		/// </summary>
		
		public TList<StaffRoles> StaffRolesCollection
		{
			get
			{
				if (_staffRolesStaffId == null)
				{
				_staffRolesStaffId = new TList<StaffRoles>();
				}
	
				return _staffRolesStaffId;
			}
			set { _staffRolesStaffId = value; }
		}
		...
		public Object Clone()
		{
			...
			//deep copy nested objects
			if (this._nurseAppointmentNurseId != null)
				_tmp.NurseAppointmentCollection = (TList<NurseAppointment>) MakeCopyOf(this.NurseAppointmentCollection); 
			...
			if (this._staffRolesStaffId != null)
				_tmp.StaffRolesCollection = (TList<StaffRoles>) MakeCopyOf(this.StaffRolesCollection); 
		...
		public object Clone(IDictionary existingCopies)
		{
			...
			#region Child Collections
			//deep copy nested objects
			_tmp.NurseAppointmentCollection = (TList<NurseAppointment>) MakeCopyOf(this.NurseAppointmentCollection, existingCopies); 
			...
			_tmp.StaffRolesCollection = (TList<StaffRoles>) MakeCopyOf(this.StaffRolesCollection, existingCopies); 
	...
	public class StaffKey : EntityKeyBase
	{
		...
		/// Initializes a new instance of the StaffKey class.
		/// </summary>
		public StaffKey(System.Int32 _id)
		{
			#region Init Properties
	...
	public enum StaffColumn : int
	{
		...
		[ColumnEnum("ShortName", typeof(System.String), System.Data.DbType.String, false, false, true, 50)]
		ShortName = 4,
		/// <summary>
		/// GroupId : 
		/// </summary>
		...
		[ColumnEnum("UserName", typeof(System.String), System.Data.DbType.String, false, false, true, 200)]
		UserName = 6,
		/// <summary>
		/// Address : 
		/// </summary>
		...
		[ColumnEnum("IsFemale", typeof(System.Boolean), System.Data.DbType.Boolean, false, false, true)]
		IsFemale = 12,
		/// <summary>
		/// Title : 
		/// </summary>

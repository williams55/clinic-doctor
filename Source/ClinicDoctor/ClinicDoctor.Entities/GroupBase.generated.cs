...
namespace ClinicDoctor.Entities
{
	...
	{		
		...
		///	which are related to this object through the relation FK_GroupRoles_Group
		/// </summary>	
		[System.ComponentModel.Bindable(System.ComponentModel.BindableSupport.Yes)]
...
/*
	...
	internal protected class GroupEntityData : ICloneable, ICloneableEx
	{
		...
		private TList<GroupRoles> _groupRolesGroupId;
		
		/// <summary>
		///	Holds a collection of entity objects
		///	which are related to this object through the relation _groupRolesGroupId
		/// </summary>
		...
		public TList<GroupRoles> GroupRolesCollection
		{
			get
			{
				if (_groupRolesGroupId == null)
				{
				_groupRolesGroupId = new TList<GroupRoles>();
				}
	
				return _groupRolesGroupId;
			}
			set { _groupRolesGroupId = value; }
		}
		...
		public Object Clone()
		{
			...
			if (this._groupRolesGroupId != null)
	...
	public class GroupKey : EntityKeyBase
	{
		...
		/// Initializes a new instance of the GroupKey class.
		/// </summary>
		public GroupKey(System.Int32 _id)
		{
			#region Init Properties

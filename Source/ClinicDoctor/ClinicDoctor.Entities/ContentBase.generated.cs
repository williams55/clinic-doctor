...
/*
	...
	Important: Do not modify this file. Edit the file Content.cs instead.
*/
...
{
	///<summary>
	/// An object representation of the 'Content' table. [No description found the database]	
	///</summary>
	[Serializable]
	[DataObject, CLSCompliant(true)]
	public abstract partial class ContentBase : EntityBase, IContent, IEntityId<ContentKey>, System.IComparable, System.ICloneable, ICloneableEx, IEditableObject, IComponent, INotifyPropertyChanged
	{		
		...
		/// </summary>
		private ContentEntityData entityData;
		
		/// <summary>
		/// 	Hold the original data of the entity, as loaded from the repository.
		/// </summary>
		private ContentEntityData _originalData;
		
		/// <summary>
		/// 	Hold a backup of the inner data of the entity.
		/// </summary>
		private ContentEntityData backupData; 
		...
		[NonSerialized]
		private TList<Content> parentCollection;
		...
		/// </summary>
		[field:NonSerialized]
		public event ContentEventHandler ColumnChanging;		
		
		/// <summary>
		/// Occurs after a value has been changed for the specified column.
		/// </summary>
		[field:NonSerialized]
		public event ContentEventHandler ColumnChanged;
		...
		public ContentBase(System.String _title, System.Int32? _funcId, System.String _note, 
		...
		///<summary>
		/// A simple factory method to create a new <see cref="Content"/> instance.
		///</summary>
		///<param name="_title"></param>
		///<param name="_funcId"></param>
		///<param name="_note"></param>
		...
		///<param name="_updateUser"></param>
		///<param name="_updateDate"></param>
		public static Content CreateContent(System.String _title, System.Int32? _funcId, System.String _note, 
			System.Boolean? _isDisabled, System.String _createUser, System.DateTime? _createDate, System.String _updateUser, 
			System.DateTime? _updateDate)
		{
			...
			newContent.CreateDate = _createDate;
			newContent.UpdateUser = _updateUser;
			newContent.UpdateDate = _updateDate;
			return newContent;
		}
		...
		public override System.Int32 Id
		{
			...
			set
			{
				...
				OnColumnChanging(ContentColumn.Id, this.entityData.Id);
				this.entityData.Id = value;
				this.EntityId.Id = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ContentColumn.Id, this.entityData.Id);
		...
		public virtual System.String Title
		{
			...
			set
			{
				...
				OnColumnChanging(ContentColumn.Title, this.entityData.Title);
				this.entityData.Title = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ContentColumn.Title, this.entityData.Title);
		...
		public virtual System.Int32? FuncId
		{
			...
			set
			{
				...
				OnColumnChanging(ContentColumn.FuncId, this.entityData.FuncId);
		...
		public virtual System.String Note
		{
			...
			set
			{
				...
				OnColumnChanging(ContentColumn.Note, this.entityData.Note);
				this.entityData.Note = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ContentColumn.Note, this.entityData.Note);
		...
		public override System.Boolean? IsDisabled
		{
			...
			set
			{
				...
				OnColumnChanging(ContentColumn.IsDisabled, this.entityData.IsDisabled);
				this.entityData.IsDisabled = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ContentColumn.IsDisabled, this.entityData.IsDisabled);
		...
		public override System.String CreateUser
		{
			...
			set
			{
				...
				OnColumnChanging(ContentColumn.CreateUser, this.entityData.CreateUser);
				this.entityData.CreateUser = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ContentColumn.CreateUser, this.entityData.CreateUser);
		...
		public override System.DateTime? CreateDate
		{
			...
			set
			{
				...
				OnColumnChanging(ContentColumn.CreateDate, this.entityData.CreateDate);
				this.entityData.CreateDate = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ContentColumn.CreateDate, this.entityData.CreateDate);
		...
		public override System.String UpdateUser
		{
			...
			set
			{
				...
				OnColumnChanging(ContentColumn.UpdateUser, this.entityData.UpdateUser);
				this.entityData.UpdateUser = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ContentColumn.UpdateUser, this.entityData.UpdateUser);
		...
		public override System.DateTime? UpdateDate
		{
			...
			set
			{
				...
				OnColumnChanging(ContentColumn.UpdateDate, this.entityData.UpdateDate);
				this.entityData.UpdateDate = value;
				if (this.EntityState == EntityState.Unchanged)
					this.EntityState = EntityState.Changed;
				OnColumnChanged(ContentColumn.UpdateDate, this.entityData.UpdateDate);
		...
		///	which are related to this object through the relation FK_Appointment_Content
		/// </summary>	
		...
		void IEditableObject.BeginEdit() 
	    {
	        ...
	        if (!inTxn) 
	        {
	            this.backupData = this.entityData.Clone() as ContentEntityData;
	            inTxn = true;
	        ...
	        if (this.inTxn) 
	        {
	        	...
	        	//if (this.EntityState == EntityState.Added)
	        	{
					if (this.parentCollection != null)
						this.parentCollection.Remove( (Content) this ) ;
				}	            
	        }
	    ...
	    public override object ParentCollection
	    {
	        ...
	        set 
	        {
	            this.parentCollection = value as TList<Content>;
	        }
	    }
	    ...
	    private void OnEntityChanged() 
	    {
	        ...
	        {
	            this.parentCollection.EntityChanged(this as Content);
	        }
	    }
		...
		///<summary>
		///  Returns a Typed Content Entity 
		///</summary>
		protected virtual Content Copy(IDictionary existingCopies)
		{
		...
		///<summary>
		///  Returns a Typed Content Entity which is a deep copy of the current entity.
		///</summary>
		public virtual Content DeepCopy()
		{
			return EntityHelper.Clone<Content>(this as Content);	
		}
		#endregion
		...
		public override void CancelChanges()
		{
			...
			{
				this.entityData = this._originalData.Clone() as ContentEntityData;
			}
			else
			{
		...
		public override void AcceptChanges()
		{
			...
			this._originalData = this.entityData.Clone() as ContentEntityData;
		}
		...
		/// </returns>
		public bool IsPropertyChanged(ContentColumn column)
		{
			switch(column)
			{
					case ContentColumn.Id:
					return entityData.Id != _originalData.Id;
					case ContentColumn.Title:
		...
		{
			return 	IsPropertyChanged(EntityHelper.GetEnumValue< ContentColumn >(columnName));
		}
		...
		///<summary>
		///  Returns a Content Entity with the original data.
		///</summary>
		public Content GetOriginalEntity()
		{
	...
	#region Value Semantics Instance Equality
        ...
        ///<returns>true if Object1 is a <see cref="ContentBase"/> and has the same value as this instance; otherwise, false.</returns>
        public override bool Equals(object Object1)
        {
			// Cast exception if Object1 is null or DbNull
			if (Object1 != null && Object1 != DBNull.Value && Object1 is ContentBase)
				return ValueEquals(this, (ContentBase)Object1);
			else
				return false;
        }
        ...
        /// Provides a hash function that is appropriate for <see cref="ContentBase"/> class 
		...
		///<returns>true if toObject is a <see cref="ContentBase"/> and has the same value as this instance; otherwise, false.</returns>
		public virtual bool Equals(ContentBase toObject)
		{
			if (toObject == null)
				return false;
		...
		///<summary>
		/// Determines whether the specified <see cref="ContentBase"/> instances are considered equal using value semantics.
		///</summary>
		///<param name="Object1">The first <see cref="ContentBase"/> to compare.</param>
		///<param name="Object2">The second <see cref="ContentBase"/> to compare. </param>
		///<returns>true if Object1 is the same instance as Object2 or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
		public static bool ValueEquals(ContentBase Object1, ContentBase Object2)
		{
			// both are null
		...
		public virtual int CompareTo(object obj)
		{
			...
			//return this. GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]) .CompareTo(((ContentBase)obj).GetPropertyName(SourceTable.PrimaryKey.MemberColumns[0]));
		}
		
		/*
		// static method to get a Comparer object
        public static ContentComparer GetComparer()
        {
            return new ContentComparer();
        }
        */

        // Comparer delegates back to Content
...
/*
        ...
        public int CompareTo(Content rhs, ContentColumn which)
        {
            switch (which)
            {
        ...
        */
		...
		#region IEntityKey<ContentKey> Members
		
		// member variable for the EntityId property
		private ContentKey _entityId;

		/// <summary>
		/// Gets or sets the EntityId property.
		/// </summary>
		[XmlIgnore]
		public virtual ContentKey EntityId
		{
			get
			{
				if ( _entityId == null )
				{
					_entityId = new ContentKey(this);
				}
		...
		public override string EntityTrackingKey
		{
			get
			{
				if(entityTrackingKey == null)
					entityTrackingKey = new System.Text.StringBuilder("Content")
	...
	/// <summary>
	///		The data structure representation of the 'Content' table.
	/// </summary>
	/// <remarks>
	...
	[Serializable]
	internal protected class ContentEntityData : ICloneable, ICloneableEx
	{
		#region Variable Declarations
		...
		/// Id : 
		/// </summary>
		/// <remarks>Member of the primary key of the underlying table "Content"</remarks>
		...
		private TList<Appointment> _appointmentContentId;
		
		/// <summary>
		///	Holds a collection of entity objects
		///	which are related to this object through the relation _appointmentContentId
		/// </summary>
		...
		public TList<Appointment> AppointmentCollection
		{
			get
			{
				if (_appointmentContentId == null)
				{
				_appointmentContentId = new TList<Appointment>();
				}
	
				return _appointmentContentId;
			}
			set { _appointmentContentId = value; }
		}
		...
		public Object Clone()
		{
			ContentEntityData _tmp = new ContentEntityData();
			...
			//deep copy nested objects
			if (this._appointmentContentId != null)
		...
		/// </summary>
		/// <param name="column">The <see cref="ContentColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanging(ContentColumn column)
		{
		...
		/// </summary>
		/// <param name="column">The <see cref="ContentColumn"/> which has raised the event.</param>
		public virtual void OnColumnChanged(ContentColumn column)
		{
		...
		public virtual void OnColumnChanging(ContentColumn column, object value)
		{
			...
			if (!SuppressEntityEvents)
			{
				ContentEventHandler handler = ColumnChanging;
				if(handler != null)
				{
					handler(this, new ContentEventArgs(column, value));
				}
			}
		}
		...
		/// <param name="column">The <see cref="ContentColumn"/> which has raised the event.</param>
		/// <param name="value">The changed value.</param>
		public virtual void OnColumnChanged(ContentColumn column, object value)
		{
			if (!SuppressEntityEvents)
			{
				ContentEventHandler handler = ColumnChanged;
				if(handler != null)
				{
					handler(this, new ContentEventArgs(column, value));
				}
	...
	#region ContentEventArgs class
	/// <summary>
	/// Provides data for the ColumnChanging and ColumnChanged events.
	/// </summary>
	/// <remarks>
	/// The ColumnChanging and ColumnChanged events occur when a change is made to the value 
	/// of a property of a <see cref="Content"/> object.
	/// </remarks>
	public class ContentEventArgs : System.EventArgs
	{
		private ContentColumn column;
		private object value;
		
		///<summary>
		/// Initalizes a new Instance of the ContentEventArgs class.
		///</summary>
		public ContentEventArgs(ContentColumn column)
		{
			this.column = column;
		}
		...
		/// Initalizes a new Instance of the ContentEventArgs class.
		///</summary>
		public ContentEventArgs(ContentColumn column, object value)
		{
			this.column = column;
			this.value = value;
		}
		...
		///<summary>
		/// The ContentColumn that was modified, which has raised the event.
		///</summary>
		///<value cref="ContentColumn" />
		public ContentColumn Column { get { return this.column; } }
	...
	///<summary>
	/// Define a delegate for all Content related events.
	///</summary>
	public delegate void ContentEventHandler(object sender, ContentEventArgs e);
	
	#region ContentComparer
		
	/// <summary>
	///	Strongly Typed IComparer
	/// </summary>
	public class ContentComparer : System.Collections.Generic.IComparer<Content>
	{
		ContentColumn whichComparison;
		
		/// <summary>
        /// Initializes a new instance of the <see cref="T:ContentComparer"/> class.
        /// </summary>
        ...
        public ContentComparer(ContentColumn column)
        {
            this.whichComparison = column;
        }

		/// <summary>
        /// Determines whether the specified <c cref="Content"/> instances are considered equal.
        /// </summary>
        /// <param name="a">The first <c cref="Content"/> to compare.</param>
        /// <param name="b">The second <c>Content</c> to compare.</param>
        /// <returns>true if objA is the same instance as objB or if both are null references or if objA.Equals(objB) returns true; otherwise, false.</returns>
        public bool Equals(Content a, Content b)
        {
        ...
        /// <returns></returns>
        public int GetHashCode(Content entity)
        {
        ...
        public ContentColumn WhichComparison
        {
	...
	#region ContentKey Class

	/// <summary>
	/// Wraps the unique identifier values for the <see cref="Content"/> object.
	/// </summary>
	[Serializable]
	[CLSCompliant(true)]
	public class ContentKey : EntityKeyBase
	{
		#region Constructors
		
		/// <summary>
		/// Initializes a new instance of the ContentKey class.
		/// </summary>
		public ContentKey()
		{
		}
		...
		/// Initializes a new instance of the ContentKey class.
		/// </summary>
		public ContentKey(ContentBase entity)
		{
			this.Entity = entity;
		...
		/// Initializes a new instance of the ContentKey class.
		/// </summary>
		public ContentKey(System.Int32 _id)
		{
			#region Init Properties
	...
	#region ContentColumn Enum
	
	/// <summary>
	/// Enumerate the Content columns.
	/// </summary>
	[Serializable]
	public enum ContentColumn : int
	{
		/// <summary>
		/// Id : 
		/// </summary>

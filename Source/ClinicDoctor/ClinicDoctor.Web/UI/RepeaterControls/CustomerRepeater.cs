...
//      }
		...
		protected override int CreateChildControls(System.Collections.IEnumerable dataSource, bool dataBinding)
         ...
         if (dataBinding)
         {
			...
			if (dataSource != null)
			{
				...
				{
						ClinicDoctor.Entities.Customer entity = o as ClinicDoctor.Entities.Customer;
	...
	{
		private ClinicDoctor.Entities.Customer _entity;
        ...
        /// <summary>
        /// Gets a <see cref="T:ClinicDoctor.Entities.Customer"></see> object
        /// </summary>
        /// <value></value>
        [System.ComponentModel.Bindable(true)]
        public ClinicDoctor.Entities.Customer Entity
        {
            get { return _entity; }
        }
	}

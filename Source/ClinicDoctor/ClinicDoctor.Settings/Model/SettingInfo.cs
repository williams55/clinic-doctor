...
using ClinicDoctor.Settings.FileConfiguration;
using ClinicDoctor.Data.Bases;

namespace ClinicDoctor.Settings.Model
{
    public class SettingInfo
    {
        ...
        public static SettingInfo LoadSetting(string code)
        {
            ...
            NetTiersServiceSection section = (NetTiersServiceSection)WebConfigurationManager.GetSection("ClinicDoctor.Data");
